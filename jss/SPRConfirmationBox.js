var dhxWins;
	...
	function downloadReport(reportType,option,termsConditionURL){
		...
		if(dhxWins.window("containerPositionPopUp")==null){
			...
			div.id="popupDiv";
			div.innerHTML = "<div style='padding-left:10px;padding-top:30px;' class='black_ar'><input type='checkbox' name='termCheckbox' id='termCheckbox' value='termCheckbox' onClick='enableAgree()'><span style='vertical-align:2px;display:inline-block;'>I agree to the <a href='"+termsConditionURL+"' target='_blank'>Terms & Condiitons.</a></span></div>"
