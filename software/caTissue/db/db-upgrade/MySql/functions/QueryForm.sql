create or replace
function query_formation_excol(event_name in varchar2)
  RETURN varchar2 AS 
          ...
          accpt_col_name varchar2(500);
          cnct_col_name varchar2(500);
          accpt_attrib_name varchar2(500);
          cnct_attrib_name varchar2(500);
          dyn_col_name_prt1 varchar2(500);
          dyn_col_name_prt2 varchar2(500);
          dyn_col_name varchar2(1000);
  ...
  begin
   ...
   open Event_migrate;
         ...
         qur :='insert into '||tbl_name||'('||accpt_col_name||')'||'values(:1, :2, :3, :4)';
        
         
          
        
        return qur;
     end query_formation_excol;   
