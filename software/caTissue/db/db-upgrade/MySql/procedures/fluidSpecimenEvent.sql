drop procedure if exists   Fluid_call_parameter;
//
CREATE  PROCEDURE   Fluid_call_parameter()
Begin
  ...
  declare event_name varchar (100) default 'FluidSpecimenReviewEventParameters';
  #-----------------------@using parameter-----------------------------
 ...
 #-------------------------------------------------------------------
  declare mig_cursor  cursor for 
    select spec.identifier,
      ...
      from   catissue_fluid_spe_event_param dispo,
