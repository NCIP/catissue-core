drop procedure if exists   in_out_call_parameter;
//
CREATE  PROCEDURE   in_out_call_parameter()
Begin
  ...
  declare dispo_STORAGE_STATUS Text;
  declare query_text Text;
  declare query_text_form Text;
  declare event_name varchar (100) default 'CheckInCheckOutEventParameter';
  #-----------------------@using parameter-----------------------------
 ...
 #-------------------------------------------------------------------
  ...
  #------------------------------------------------------------------------------------------------------------------       
   ...
   set @des_reason := dispo_STORAGE_STATUS;
