CREATE OR replace PROCEDURE Embedded_event_migrate(event_name in varchar2)
IS 
  counter                   INTEGER; 
...
BEGIN 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, embed_medium, 
      parent_specimen_id; 
...
USING embed_medium, specimen_event_identifier, seqval; 
