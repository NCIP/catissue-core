create or replace
PROCEDURE Tissue_specimen_event_migrate(event_name in varchar2)
IS 
  counter                   INTEGER; 
  ...
  CURSOR mig_cursor IS 
    ...
    WHERE  tis.identifier = spec.identifier 
...
BEGIN 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, dispo_neo, dispo_nec, 
      dispo_lym 
      , 
      dispo_tot, dispo_his, parent_specimen_id; 
      ...
      IF flag = 0 THEN 
        ...
        BEGIN 
            ...
            USING dispo_his, specimen_event_identifier, dispo_lym, dispo_nec, 
            dispo_neo, 
            dispo_tot, seqval; 
