create or replace
PROCEDURE Collection_event_migrate(event_name in varchar2)
IS 
  counter                    NUMBER (25); 
  ...
  flag                       INTEGER; 
  dispo_collection_procedure VARCHAR2(2000); 
  dispo_container            VARCHAR2(2000); 
...
BEGIN 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, dispo_collection_procedure, 
      dispo_container, parent_specimen_id; 
...
USING dispo_collection_procedure,dispo_container,specimen_event_identifier,  
seqval; 
