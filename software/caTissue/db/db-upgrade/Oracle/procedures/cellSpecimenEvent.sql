create or replace
PROCEDURE Cell_event_migrate(event_name in varchar2)
IS 
  counter                      NUMBER (25); 
  ...
  flag                         INTEGER; 
  dispo_neoplastic             NUMBER(25, 10); 
  dispo_viable_cell_percentage NUMBER(25, 10); 
...
BEGIN 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, dispo_neoplastic, 
      dispo_viable_cell_percentage, parent_specimen_id; 
