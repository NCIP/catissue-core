CREATE OR replace PROCEDURE Fluid_event_migrate(event_name in varchar2)
IS 
  counter                   INTEGER; 
  ...
  CURSOR mig_cursor IS 
    ...
    WHERE  fluid.identifier = spec.identifier 
...
BEGIN 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, cell_count, 
      parent_specimen_id; 
...
USING cell_count, specimen_event_identifier, seqval; 
