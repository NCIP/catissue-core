create or replace
PROCEDURE Procedure_event_migrate(event_name in varchar2)
IS 
  counter                   NUMBER (25); 
  ...
  flag                      INTEGER; 
  dispo_name                VARCHAR2(2000); 
  dispo_url                 VARCHAR2(2000); 
...
BEGIN 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, dispo_name, dispo_url, 
      parent_specimen_id; 
...
USING specimen_event_identifier,dispo_name,dispo_url,seqval; 
