create or replace
PROCEDURE Thaw_event_migrate(event_name in varchar2)
IS 
  counter                   INTEGER; 
  ...
  CURSOR mig_cursor IS 
    ...
    WHERE  tha.identifier = spec.identifier 
...
BEGIN 
  ...
  SELECT Query_formation('ThawEventParameters') 
  INTO   query_text 
  FROM   dual; 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, parent_specimen_id; 
...
USING specimen_event_identifier, seqval; 
