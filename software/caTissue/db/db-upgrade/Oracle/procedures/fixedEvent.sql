create or replace
PROCEDURE Fixed_event_migrate(event_name in varchar2)
IS 
  counter                   NUMBER (25); 
  ...
  flag                      INTEGER; 
  dispo_fixation_type       VARCHAR2(2000); 
...
BEGIN 
  ...
  LOOP 
      ...
      specimen_timestamp 
      , specimen_event_user_id, specimen_comments, dispo_fixation_type, 
      dispo_dur_min, 
      parent_specimen_id; 
...
USING dispo_dur_min, dispo_fixation_type, specimen_event_identifier, seqval; 
