create or replace
function query_formation_singleId(event_name in varchar2)
  RETURN varchar2 AS 
          ...
          cnct_col_name varchar2(100);
          accpt_attrib_name varchar2(100);
          cnct_attrib_name varchar2(100);
          dyn_col_name_prt1 varchar2(50);
          dyn_col_name_prt2 varchar2(50);
  ...
  begin
   ...
   open Event_migrate;
         ...
         qur :='insert into '||tbl_name||'('||accpt_col_name||')'||'values(:1, :2)';
        
         
          
        
        return qur;
     end query_formation_singleId;   
