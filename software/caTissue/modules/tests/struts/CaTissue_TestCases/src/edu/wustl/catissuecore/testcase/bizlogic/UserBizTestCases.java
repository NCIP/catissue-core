 ...
 * @author sagar_baldwa
 */
public class UserBizTestCases extends CaTissueSuiteBaseTest {
	 ...
	 */public void testAddUser()
	 {
		 try{
			...
			BizTestCaseUtility.setObjectMap(user, User.class);
...
// 				+ "user.id= 1";//+cachedUser.getId();
//        	 List resultList = appService.search(query,User.class);
...
//			//assertTrue("Cannot enter a User without an Email Address", true);
//
...
//			//assertTrue("Cannot enter a User without a its City Name",true);
