...
public class SpecimenEventBizTestCases extends CaTissueSuiteBaseTest
{
	...
	public void testInsertDisposeSpecimenEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(disposalEvent, DisposalEventParameters.class);
	...
	public void testUpdateDisposeSpecimenEvent()
	{
		try
		{
			DisposalEventParameters disposalEvent = (DisposalEventParameters) BizTestCaseUtility.getObjectMap(DisposalEventParameters.class);
			disposalEvent.setActivityStatus(Status.ACTIVITY_STATUS_DISABLED.toString());
			disposalEvent = (DisposalEventParameters) appService.updateObject(disposalEvent);
	...
	public void testInsertCellSpecimenReviewEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(cellSpecimenReviewParameters, CellSpecimenReviewParameters.class);
	...
	public void testUpdateCellSpecimenReviewParameters()
	{
		try
		{
			CellSpecimenReviewParameters csrp = (CellSpecimenReviewParameters) BizTestCaseUtility.getObjectMap(CellSpecimenReviewParameters.class);
	...
	public void testInsertCheckInCheckOutEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(checkInCheckOutEventParameter, CheckInCheckOutEventParameter.class);
	...
	public void testUpdateCheckInCheckOutEvent()
	{
		try
		{
			CheckInCheckOutEventParameter cico = (CheckInCheckOutEventParameter) BizTestCaseUtility.getObjectMap(CheckInCheckOutEventParameter.class);
	...
	public void testInsertCollectionEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(collectionEventParameter, CollectionEventParameters.class);
	...
	public void testUpdateCollectionEvent()
	{
		try
		{
			CollectionEventParameters collectionEventParameter = (CollectionEventParameters) BizTestCaseUtility
	...
	public void testInsertEmbeddedEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(embeddedEventParameters, EmbeddedEventParameters.class);
	...
	public void testUpdateEmbeddedEvent()
	{
		try
		{
			EmbeddedEventParameters embeddedEventParameters = (EmbeddedEventParameters) BizTestCaseUtility.getObjectMap(EmbeddedEventParameters.class);
	...
	public void testInsertFixedEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(fixedEventParameters, FixedEventParameters.class);
	...
	public void testUpdateFixedEvent()
	{
		try
		{
			FixedEventParameters fixedEventParameters = (FixedEventParameters) BizTestCaseUtility.getObjectMap(FixedEventParameters.class);
	...
	public void testInsertFluidSpecimenReview()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(fluidSpecimenReviewEventParameters, FluidSpecimenReviewEventParameters.class);
	...
	public void testUpdateFluidSpecimenReviewEventParameters()
	{
		try
		{
			FluidSpecimenReviewEventParameters fluidSpecimenReviewEventParameters = (FluidSpecimenReviewEventParameters) BizTestCaseUtility
	...
	public void testInsertFrozenSpecimenReviewEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(frozenEventParameters, FrozenEventParameters.class);
	...
	public void testUpdateFrozenSpecimenReviewEventParameters()
	{
		try
		{
			FrozenEventParameters frozenEventParameters = (FrozenEventParameters) BizTestCaseUtility.getObjectMap(FrozenEventParameters.class);
	...
	public void testInsertSpunSpecimenEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(spunEventParameters, SpunEventParameters.class);
	...
	public void testUpdatetestInsertSpunSpecimenEvent()
	{
		try
		{
			SpunEventParameters spunEventParameters = (SpunEventParameters) BizTestCaseUtility.getObjectMap(SpunEventParameters.class);
	...
	public void testInsertThawSpecimenEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(thawEventParameters, ThawEventParameters.class);
	...
	public void testUpdateThawSpecimenEvent()
	{
		try
		{
			ThawEventParameters thawEventParameters = (ThawEventParameters) BizTestCaseUtility.getObjectMap(ThawEventParameters.class);
	...
	public void testInsertTissueSpecimenReviewEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(tsReviewEventParameters, TissueSpecimenReviewEventParameters.class);
	...
	public void testUpdateTissueSpecimenReviewEvent()
	{
		try
		{
			TissueSpecimenReviewEventParameters tsReviewEventParameters = (TissueSpecimenReviewEventParameters) BizTestCaseUtility
	...
	public void testInsertReceivedSpecimenEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(receivedEventParameters, ReceivedEventParameters.class);
	...
	public void testUpdateReceivedSpecimenEvent()
	{
		try
		{
			...
			ReceivedEventParameters receivedEventParameters = (ReceivedEventParameters) BizTestCaseUtility.getObjectMap(ReceivedEventParameters.class);
	...
	public void testInsertProcedureSpecimenEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(procEventParameters, ProcedureEventParameters.class);
	...
	public void testUpdateProcedureSpecimenEvent()
	{
		try
		{
			ProcedureEventParameters procEventParameters = (ProcedureEventParameters) BizTestCaseUtility.getObjectMap(ProcedureEventParameters.class);
	...
	public void testInsertMolecularSpecimenReviewEvent()
	{
		try
		{
			...
			BizTestCaseUtility.setObjectMap(molecularSpecEventParameters, MolecularSpecimenReviewParameters.class);
	...
	public void testUpdateMolecularSpecimenReviewEvent()
	{
		try
		{
			MolecularSpecimenReviewParameters molecularSpecEventParameters = (MolecularSpecimenReviewParameters) BizTestCaseUtility
