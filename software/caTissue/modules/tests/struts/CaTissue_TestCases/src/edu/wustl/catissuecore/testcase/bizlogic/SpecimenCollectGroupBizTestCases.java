...
public class SpecimenCollectGroupBizTestCases extends CaTissueSuiteBaseTest
{
	...
	public void testUpdateSpecimenCollectionGroupWithConsents()
	{
		try
		{
			SpecimenCollectionGroup specimenCollGroup = (SpecimenCollectionGroup)BizTestCaseUtility.getObjectMap(SpecimenCollectionGroup.class);
    ...
    {
		SpecimenCollectionGroup scg = new SpecimenCollectionGroup();
    	SpecimenCollectionGroup cachedSCG = (SpecimenCollectionGroup) BizTestCaseUtility.getObjectMap(SpecimenCollectionGroup.class);
    	scg.setId((Long) cachedSCG.getId());
     	Logger.out.info(" searching domain object");
    	 try {
    		 String query = "from edu.wustl.catissuecore.domain.SpecimenCollectionGroup as specimenCollectionGroup where "
 				+ "specimenCollectionGroup.id= "+cachedSCG.getId();	
	...
	{ 
		...
		specimenCollectionGroup.setBarcode(((SpecimenCollectionGroup) BizTestCaseUtility.getObjectMap(SpecimenCollectionGroup.class)).getBarcode());
		 try {
			 String query = "from edu.wustl.catissuecore.domain.SpecimenCollectionGroup as specimenCollectionGroup where "
					+ "specimenCollectionGroup.barcode= '"+ ((SpecimenCollectionGroup) BizTestCaseUtility.getObjectMap(SpecimenCollectionGroup.class)).getBarcode()+"'";	
        	 List resultList = appService.search(query);
        	 if(resultList!=null)
        	 {
//        	
	...
	public void testUpdateSCGWithDuplicateName()
	{
		...
		try{
		  ...
		  //  TestCaseUtility.setObjectMap(scg, SpecimenCollectionGroup.class);
		    ...
		    scg = (SpecimenCollectionGroup)appService.createObject(scg);
		    duplicateSCG = (SpecimenCollectionGroup)appService.createObject(duplicateSCG);
		    duplicateSCG.setName(((SpecimenCollectionGroup) BizTestCaseUtility.getObjectMap(SpecimenCollectionGroup.class)).getName());
...
//		try {
//			new ExcelTestCaseUtility().addAnticipatedSCGInParticipant();
