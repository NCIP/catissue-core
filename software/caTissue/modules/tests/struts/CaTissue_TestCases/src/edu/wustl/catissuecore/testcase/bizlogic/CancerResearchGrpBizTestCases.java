...
public class CancerResearchGrpBizTestCases extends CaTissueSuiteBaseTest {
	...
	public void testAddCancerResearchGrp()
	{
		try{
			...
			BizTestCaseUtility.setObjectMap(crg,CancerResearchGroup.class);
	...
	public void testSearchCancerResearchGrp()
	{
	    	...
	    	crg.setId(new Long(1));
	         ...
	         try {
	        	 String query = "from edu.wustl.catissuecore.domain.CancerResearchGroup as cancerResearchGroup where "
	 				+ "cancerResearchGroup.id=1";	
