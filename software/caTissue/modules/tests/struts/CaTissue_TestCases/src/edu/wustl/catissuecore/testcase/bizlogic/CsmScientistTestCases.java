...
public class CsmScientistTestCases extends BaseTestCase{
	static ApplicationService appService = null;
	  ...
	  public void setUp(){
		//Logger.configure("");
		appService = null;//ApplicationServiceProvider.getApplicationService();
	  ...
	  public void testSearchCPWithAllowReadPrevilegeForScientist()
		{
	    	...
	    	collectionProtocol.setId(new Long(BizTestCaseUtility.CP_WITH_ALLOW_READ_PRIV));
	  ...
	  public void testSearchCPWithDisallowReadPrevilegeForScientist()
		{
	    	CollectionProtocol collectionProtocol = new CollectionProtocol();
	    	collectionProtocol.setId(new Long(BizTestCaseUtility.CP_WITH_DISALLOW_READ_PRIV));
	       	Logger.out.info(" searching domain object");
	    	try {
	        	 List resultList = appService.search(CollectionProtocol.class,collectionProtocol);
	  ...
	  public void testReadPHIdataOfParticipantRegisteredToCPWithAllowReadPrivilegeForScientist()
    	...
    	try{
	    	...
	    	Participant cachedParticipant = (Participant) BizTestCaseUtility.getNameObjectMap("ParticipantUnderCPWithAllowUsePriv");
	  ...
	  public void testReadPHIdataOfSCGUnderCPWithAllowReadPrivilegeForScientist()
	    ...
	    try{
	    	...
	    	SpecimenCollectionGroup cachedSCG =(SpecimenCollectionGroup) BizTestCaseUtility.getNameObjectMap("SCGUnderCPWithAllowUsePriv");
	 ...
	 public void testReadPHIdataForParticipantRegisteredUnderCPHavingScientistAsPIForScientist()
	   {
		...
		Participant cachedParticipant = (Participant) BizTestCaseUtility.getNameObjectMap("ParticipantWithScientistAsPI");
		Participant participant = new Participant();
		participant.setId(cachedParticipant.getId());
	  	System.out.println("searching domain object");
	    Logger.out.info(" searching domain object");
	  ...
	  public void testReadPHIDataOfSCGUnderCPHavingScientistAsPIForScientist()
	   {
		...
		SpecimenCollectionGroup cachedSCG = (SpecimenCollectionGroup) BizTestCaseUtility.getNameObjectMap("SCGWithScientistAsPI");
		SpecimenCollectionGroup scg = new SpecimenCollectionGroup();
		scg.setId(cachedSCG.getId());
	  	System.out.println("searching domain object");
	    Logger.out.info(" searching domain object");
	  ...
	  public void testReadPHIdataOfParticipantRegisteredUnderCPWithDisallowReadPrivForScientist()
	   {
		...
		Participant cachedParticipant = (Participant) BizTestCaseUtility.getNameObjectMap("ParticipantUnderCPWithDisallowUsePriv");
		Participant participant = new Participant();
		participant.setId(cachedParticipant.getId());
	  	System.out.println("searching domain object");
	    Logger.out.info(" searching domain object");
	  ...
	  public void testReadPHIdataOfSCGUnderCPWithDisallowReadPrivForScientist()
	   {
		...
		SpecimenCollectionGroup cachedSCG = (SpecimenCollectionGroup) BizTestCaseUtility.getNameObjectMap("SCGUnderCPWithDisallowReadPriv");
		SpecimenCollectionGroup scg = new SpecimenCollectionGroup();
		scg.setId(cachedSCG.getId());
	  	System.out.println("searching domain object");
	    Logger.out.info(" searching domain object");
