 ...
 * 
 */
public class Catissue_cacoreAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://domain.catissuecore.wustl.edu/Catissue_cacore";
	
	Map authorizationClassMap = new HashMap();
	
	
	public Catissue_cacoreAuthorization() {
	}
	...
	public void authorizeInsert(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("insert")){
			authorizeInsert(peerSubject, context, operation);
			return true;
