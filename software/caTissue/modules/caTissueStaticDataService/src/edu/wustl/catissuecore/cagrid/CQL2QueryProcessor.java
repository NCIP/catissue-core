 ...
 */
public class CQL2QueryProcessor extends gov.nih.nci.cagrid.data.cql2.CQL2QueryProcessor {
    ...
    public Iterator<CQLResult> processQueryAndIterate(CQLQuery query) throws QueryProcessingException {
        ...
        if (runQuery.getCQLQueryModifier() != null) {
            ...
            cqlResultsIter = wrapAggregateResult(Aggregation.COUNT, "id", String.valueOf(rawResults.size()));
        } else {
