...
public class SpecimenForm extends AbstractActionForm
{
	...
	protected String disposeStatus;
	/**
	...
	**/
	 ...
	 */
	protected String globalSpecimenIdentifer;

	protected String globalSpecimenIdentiferCurrent;

	public String getGlobalSpecimenIdentiferCurrent() {
		return globalSpecimenIdentiferCurrent;
	}


	public void setGlobalSpecimenIdentiferCurrent(
			String globalSpecimenIdentiferCurrent) {
		this.globalSpecimenIdentiferCurrent = globalSpecimenIdentiferCurrent;
	}


	public String getGlobalSpecimenIdentifer() {
		return globalSpecimenIdentifer;
	}


	public void setGlobalSpecimenIdentifer(String globalSpecimenIdentifer) {
		this.globalSpecimenIdentifer = globalSpecimenIdentifer;
	}

	protected final boolean gsidPresent=GSIDClient.GSID_IS_ENABLED;

	public boolean isGsidPresent() {
		return gsidPresent;
	}
...
//		if(specimen.getActivityStatus().equals(Constants.ACTIVE))
//		{
//			this.disposeStatus = CommonUtilities.toString("Closed");
//		}
//		else
//		{
			this.disposeStatus = specimen.getActivityStatus();
//		}
		this.setId(specimen.getId().longValue());
		this.type = specimen.getSpecimenType();
		this.concentration = "";
		this.comments = specimen.getComment();
		this.globalSpecimenIdentifer=specimen.getGlobalSpecimenIdentifier();
...
//		this.generateLabel=specimen.getSpecimenCollectionGroup().getCollectionProtocolRegistration().getCollectionProtocol().getGenerateLabel();
		...
		{
			this.className = AppUtility.getClassName(specimen.getParentSpecimen());
		}
