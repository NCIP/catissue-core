...
public class ApproveUserBizLogic extends CatissueDefaultBizLogic
{
            ...
            final SessionDataBean sessionDataBean) throws BizLogicException
    {
        ...
        objUserBizlogic.validate(user, dao, Constants.EDIT,uiObject);
        ...
        try
        {
            ...
            emailHandler(user,userUIObject);
     ...
     */
    private void emailHandler(final User user, UserUIObject userUIObject) throws ApplicationException
    {
        final EmailHandler emailHandler = new EmailHandler();
        // If user is approved send approval and login details emails to the
        // user and administrator.
     ...
     *             BizLogicException
     */
    public void approveUser(final Object user1, final User oldUser,
            ...
            throws SMException
    {
        ...
        {
            if (Constants.SUPER_ADMIN_USER.equalsIgnoreCase(user.getRoleId()))
            {
    ...
    {
    	UserUIObject userUIObject = new UserUIObject();
    	return isAuthorized(dao,domainObject,sessionDataBean);
     ...
     */
    private boolean checkUser(final Object domainObject, final SessionDataBean sessionDataBean,Object uiObject)
            throws BizLogicException
    {
        return new UserBizLogic().checkUser(domainObject, sessionDataBean,uiObject);
    }
