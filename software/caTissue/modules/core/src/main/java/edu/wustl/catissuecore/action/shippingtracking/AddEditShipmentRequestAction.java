...
import edu.wustl.catissuecore.factory.utils.ShipmentUtility;
...
public class AddEditShipmentRequestAction extends SecureAction
{
			...
			HttpServletRequest request, HttpServletResponse response)
	{
		...
		try
		{
			...
			ShipmentRequestUIObject uiObject = (ShipmentRequestUIObject) uiObjectFactory.getUIObject((AbstractActionForm) form);
			...
			while (shipmentReqIterator.hasNext())
			{
				...
				if (request != null)
				{
					...
					{
						bizLogic.insert(shipmentRequest,uiObject, this.getSessionData(request));
