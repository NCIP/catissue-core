...
public class DefineEventsAction extends BaseAction
{
			...
			CollectionProtocolBean cpBean)
	{
		...
		cpBean.setIrbSiteId(cpForm.getIrbSiteId());
		...
		cpBean.setRemoteId(cpForm.getRemoteId());
		cpBean.setRemoteManagedFlag(cpForm.isRemoteManagedFlag());
		cpBean.setDirtyEditFlag(cpForm.isDirtyEditFlag());
