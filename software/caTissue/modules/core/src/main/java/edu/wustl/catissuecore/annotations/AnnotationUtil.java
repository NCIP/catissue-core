...

{
	 ...
	 * @return - List
	 */
	public static List<NameValueBean> getSystemEntityList() throws DynamicExtensionsSystemException,
			DynamicExtensionsApplicationException, CacheException
	{
		...
		if (staticEntityInformationList != null && !staticEntityInformationList.isEmpty())
		{
			...
			final Iterator<NameValueBean> listIterator = staticEntityInformationList.iterator();
			while (listIterator.hasNext())
			{
				final NameValueBean nameValueBean = listIterator.next();
