...
public class StorageContainerAction extends SecureAction
{
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			final ISiteBizLogic siteBizLogic = new SiteBizLogic();
			...
			StorageContainerForm storageContainerForm, DAO dao) throws ApplicationException
	{
		...
		final ISiteBizLogic siteBizlog = new SiteBizLogic();
			...
			HttpServletRequest request) throws ApplicationException
	{
		...
		if (selectedType != null && !selectedType.equals("-1"))
		{
			...
			if (object != null)
			{
				...
				if (type.getDefaultTemperatureInCentigrade() != null)
				{
					storageContainerForm.setDefaultTemperature(type
							.getDefaultTemperatureInCentigrade().toString());
				}
				...
				if (operation != null && operation.equals(Constants.ADD))
				{
					...
					final Collection<String> specimenTypeCollection = type.getHoldsSpecimenTypeCollection();
