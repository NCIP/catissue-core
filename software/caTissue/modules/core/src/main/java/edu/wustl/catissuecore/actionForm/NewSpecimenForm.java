...
public class NewSpecimenForm extends SpecimenForm implements ConsentTierData, IPrinterTypeLocation
{
	...
	private String parentSpecimenGSID;
	...
	/** Identifies if the transfer event has taken place. */
	private String transferStatus;

	/**  The reason for transferring the specimens. */
	private String reasonForTransfer;

	/** storage location from where the specimen is transferred. */
	private String fromStorageLocation;

	/** Storage container to which the specimen will be transferred. */
	private String toStorageContainer;

	/** Storage container position one to which the specimen will be transferred. */
	private String toPosOne;

	/** Storage container position two to which the specimen will be transferred. */
	private String toPosTwo;
...
//	}
	...
	/**
	 * @return the toStorageContainer
	 */
	public String getToStorageContainer() {
		return toStorageContainer;
	}

	/**
	 * @param toStorageContainer the toStorageContainer to set
	 */
	public void setToStorageContainer(String toStorageContainer) {
	 ...
	 * @return the toPosOne
	 */
	public String getToPosOne() {
		return toPosOne;
	}

	/**
	 * @param toPosOne the toPosOne to set
	 */
	public void setToPosOne(String toPosOne) {
		this.toPosOne = toPosOne;
	}

	/**
	 * @return the toPosTwo
	 */
	public String getToPosTwo() {
		return toPosTwo;
	}

	/**
	 * @param toPosTwo the toPosTwo to set
	 */
	public void setToPosTwo(String toPosTwo) {
		this.toPosTwo = toPosTwo;
	}
	...
	public void setAllValues(AbstractDomainObject abstractDomain)
	{
		...
		{
			this.setFromPositionDimensionOne(specimen.getSpecimenPosition().getPositionDimensionOne().toString());
			this.setFromPositionDimensionTwo(specimen.getSpecimenPosition().getPositionDimensionTwo().toString());
			this.setFromStorageContainerId(specimen.getSpecimenPosition().getStorageContainer().getId().toString());
		}
		...
		if (specimen.getParentSpecimen() != null)
		{
			...
			this.parentSpecimenGSID=((Specimen) specimen
			.getParentSpecimen()).getGlobalSpecimenIdentifier();
		}
...
//							receivedTime);
	...
	public String getParentSpecimenGSID() {
		return parentSpecimenGSID;
	}

	public void setParentSpecimenGSID(String parentSpecimenGSID) {
		this.parentSpecimenGSID = parentSpecimenGSID;
	}
