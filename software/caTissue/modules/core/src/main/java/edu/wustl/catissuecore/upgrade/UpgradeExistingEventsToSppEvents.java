...
public class UpgradeExistingEventsToSppEvents
{
	...
	private static final Logger LOGGER = Logger
			.getCommonLogger(UpgradeExistingEventsToSppEvents.class);
			...
			DynamicExtensionsApplicationException, DynamicExtensionsSystemException
	{
		...
		for (Object srIdentifier : allIdentifier)
		{
			...
			SpecimenProcessingProcedure aptSPP = sppHelper.getMatchingSPP(specimenRequirement.getSpecimenEventCollection());

			specimenRequirement.setProcessingSPP(aptSPP);
			...
			DynamicExtensionsSystemException
	{
		...
		for (SpecimenEventParameters specimenEventParameter : allEvents)
		{
			...
			EntityInterface sppStaticEntity = CATISSUE_ENTITY_GROUP
