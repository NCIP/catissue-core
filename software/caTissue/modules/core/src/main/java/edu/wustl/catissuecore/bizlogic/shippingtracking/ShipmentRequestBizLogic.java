...
import edu.wustl.catissuecore.uiobject.ShipmentRequestUIObject;
...
public class ShipmentRequestBizLogic extends BaseShipmentBizLogic
{
	...
	public boolean validate(final Object obj, final DAO dao, final String operation,ShipmentRequestUIObject uiObject)
			throws BizLogicException
	{
		...
		*/
		try
		{
			if (!uiObject.isRequestProcessed()
	...
	@Override
	protected void insert(Object obj,Object uiDomainObject, DAO dao, SessionDataBean sessionDataBean)
			throws BizLogicException
	{
		try
		{
			...
			if(shipmentRequest.getContainerCollection()==null)
			{
				shipmentRequest.setContainerCollection(new HashSet < StorageContainer >() ) ;
			...
			if(shipmentRequest.getSpecimenCollection()==null)
			{
				shipmentRequest.setSpecimenCollection(new  HashSet < Specimen >());
			...
			Collection < Specimen > specimenCollection, Site site)
	{
		...
		final ShipmentRequest shiRequest = shipReqInstFact.createObject();//new ShipmentRequest();
