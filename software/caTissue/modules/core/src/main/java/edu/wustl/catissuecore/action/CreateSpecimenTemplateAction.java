...
public class CreateSpecimenTemplateAction extends BaseAction
{
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		String[] sppArr=collectionProtocolEventBean.getSpecimenProcessingProcedure();
		List<NameValueBean> spp=new ArrayList<NameValueBean>();
		spp.add(new NameValueBean(Constants.NOT_SPECIFIED,Constants.NOT_SPECIFIED));
		if(sppArr!=null)
		{
			...
			HttpServletRequest request)
	{
		...
		if(specimenRequirementBean.getCreationEventForSpecimen()==null)
		{
			specimenRequirementBean.setCreationEventForSpecimen(Constants.NOT_SPECIFIED);
		}
		
			createSpecimenTemplateForm.setCreationEventForSpecimen(specimenRequirementBean.getCreationEventForSpecimen());
