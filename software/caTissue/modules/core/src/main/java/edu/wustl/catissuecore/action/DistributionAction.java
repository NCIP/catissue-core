...
public class DistributionAction extends SecureAction
{
	...
	protected void setRequestParameters(HttpServletRequest request) throws Exception
	{
		...
		final List<NameValueBean> distributionType = new ArrayList<NameValueBean>();
		...
		final List<NameValueBean> distributionBasedOn = new ArrayList<NameValueBean>();
			...
			HttpServletRequest request, String barcodeLable) throws ApplicationException
	{
		...
		try
		{
			caCoreAppServicesDelegator.searchFilter(userName, cprObjectList);
		}
