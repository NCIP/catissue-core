...
public final class IdentifiedReportGenerator
{
	...
	*/
	...
	{
		InstanceFactory<ReportSection> instFact = DomainInstanceFactory.getInstanceFactory(ReportSection.class);
		final ReportSection section = instFact.createObject();//new ReportSection();
		try
		{
