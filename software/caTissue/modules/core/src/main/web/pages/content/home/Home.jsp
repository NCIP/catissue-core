...
<%@ taglib uri="edu.wustl.catissuecore" prefix="catissue" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 --> <!--Mandar:7dec09 <br /> --></td>
		...
		<table width="95%" border="0" cellpadding="0" cellspacing="0">
			...
			<!-- Administrator alerts section starts here. -->
			<catissue:alerts/>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr class="wh_ar_b">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td nowrap="nowrap" class="td_table_head"><span
									class="wh_ar_b"><bean:message
												bundle="msg.ccts"
												key="Home.title.alerts" /></span></td>
								<td><img
									src="images/uIEnhancementImages/table_title_corner.gif"
									alt="Title" width="31" height="24" /></td>
							</tr>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="3">
							...
							<tr>
								<td><img src="images/uIEnhancementImages/alert-icon.gif" alt="Alert Icon"
									width="16" vspace="0" hspace ="0" height="18" valign="middle"></td>
			...
			<!-- Administrator alerts section ends here.   -->
			<tr>
				<td background="images/uIEnhancementImages/shadow_down.gif"></td>
				<td><img src="images/uIEnhancementImages/shadow_corner.gif"
					alt="Shadow Corner" width="5" height="5" /></td>
