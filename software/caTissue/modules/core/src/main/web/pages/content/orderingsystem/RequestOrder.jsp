...
<script type="text/javascript" src="jss/distributionCombos.js"></script>
			 ...
			 <tr>
              <td valign="top" class="cp_tabtable"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td>
										<div>
										<input property="distributionProtocol" type="text" id="distributionProtocol" name="distributionProtocol"
