	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >
		...
		<tr>
					...
					if(request.getAttribute("OrderPathologyCaseForm")!=null)
			{
					...
					String distributionProtocol = pathology.getDistrbutionProtocol();
					if(distributionProtocol == null || distributionProtocol.equals(Constants.SELECT_OPTION))
					{
			...
			<%  }
					...
					else if(request.getAttribute("OrderBiospecimenArrayForm")!=null)
				{
					...
					String distributionProtocol = form.getDistrbutionProtocol();
					if(distributionProtocol == null || distributionProtocol.equals(Constants.SELECT_OPTION))
					{
						distributionProtocol = "";
					}
			...
			<%  }
					else
				{
					...
					String distributionProtocol = orderSpecimenForm.getDistrbutionProtocol();
					if(distributionProtocol == null || distributionProtocol.equals(Constants.SELECT_OPTION))
					{
						distributionProtocol = "";
					}
