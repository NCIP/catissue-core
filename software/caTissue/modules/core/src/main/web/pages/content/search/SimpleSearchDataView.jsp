...
%>
	<script language="javascript">
		...
		function onMagetabExport()
		{
		    ...
		    if(isChecked == "true")
		    {
				var action = "MagetabExport.do?pageNum="+pageNum+"&isCheckAllAcrossAllChecked="+isCheckAllAcrossAllChecked ;
...
<!--  **************  Code for New Grid  *********************** -->
		...
		<td width="90%">
			...
			<tr>
					...
					<td width="5%" nowrap align="right" valign="top">
					<%
					if(columnList.get(1).toString().trim().endsWith("Specimen"))
					{
					%>
						<img src="images/b_magetab_exp.gif" width="104"  hspace="3" onclick="onMagetabExport()"/>&nbsp;
					<%
					}
					%>
					</td>
