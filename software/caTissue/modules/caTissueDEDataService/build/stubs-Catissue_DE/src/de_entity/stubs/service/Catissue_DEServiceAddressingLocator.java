/**
 * Catissue_DEServiceAddressingLocator.java
 *
...
public class Catissue_DEServiceAddressingLocator extends de_entity.stubs.service.Catissue_DEServiceLocator implements de_entity.stubs.service.Catissue_DEServiceAddressing {
    public de_entity.stubs.Catissue_DEPortType getCatissue_DEPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	de_entity.stubs.Catissue_DEPortType _stub = getCatissue_DEPortTypePort(endpoint);
	if (_stub != null) {
