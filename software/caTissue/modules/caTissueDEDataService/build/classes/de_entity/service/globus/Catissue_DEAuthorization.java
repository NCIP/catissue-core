 ...
 * 
 */
public class Catissue_DEAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://de_entity/Catissue_DE";
	
	Map authorizationClassMap = new HashMap();
	
	
	public Catissue_DEAuthorization() {
	}
