...
import de_entity.service.Catissue_DEConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class Catissue_DEResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(Catissue_DEResourceBase.class);

	private Catissue_DEResourceConfiguration configuration;
    ...
    public Catissue_DEResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((Catissue_DEResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(Catissue_DEConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((Catissue_DEResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(Catissue_DEConstants.SERVICEMETADATA);
	...
	public org.cagrid.dataservice.cql.support.QueryLanguageSupport getQueryLanguageSupport(){
		return ((Catissue_DEResourceProperties) getResourceBean()).getQueryLanguageSupport();
	}
	...
	public void setQueryLanguageSupport(org.cagrid.dataservice.cql.support.QueryLanguageSupport queryLanguageSupport ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(Catissue_DEConstants.QUERYLANGUAGESUPPORT);
	...
	public Catissue_DEResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (Catissue_DEResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((Catissue_DEResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((Catissue_DEResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
