...
Build tool: Ant 1.7
Application server: JBoss 5.0 GA
Java: JDK 1.6
...
install.properties: Before installing the application, all parameters required for the 
deployment process are expected to be defined by the user in this file.

Executing
========================================
To deploy: ant install
To upgrade: ant upgrade
