         ...
         if (checkedButton.equals("1"))
         {
 			if (validator.isEmpty(parentSpecimenArrayLabel))
 			{
 				errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("errors.item.required", ApplicationProperties
 						.getValue("specimenArrayAliquots.parentLabel"))); 				
 			}
 		 }
 		 else
 		 {
 			...
 			{
 				errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("errors.item.required", ApplicationProperties.getValue("specimenArrayAliquots.barcode"))); 				
 			}
 		 }
