...
public class ConsentResponseForm extends AbstractActionForm implements Serializable , ConsentTierData {
	...
	public Collection getConsentTiers()
	{
		...
		{	
			...
			strArray[2]="consentResponseValue(ConsentBean:"+consentCounter+"_participantResponse)";
			strArray[3]="consentResponseValue(ConsentBean:"+consentCounter+"_participantResponseID)";
