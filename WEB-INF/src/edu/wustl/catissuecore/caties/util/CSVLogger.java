...
public abstract class CSVLogger
{
	...
	{
		if (categoryName.equalsIgnoreCase(CaTIESConstants.LOGGER_FILE_POLLER))
		{
			filePollerOut = org.apache.log4j.Logger.getLogger(categoryName);
		}
		if (categoryName.equalsIgnoreCase(CaTIESConstants.LOGGER_QUEUE_PROCESSOR))
		{
			queueProcessorOut = org.apache.log4j.Logger.getLogger(categoryName);
		}
		if (categoryName.equalsIgnoreCase(CaTIESConstants.LOGGER_DEID_SERVER))
		{
			deidServerOut = org.apache.log4j.Logger.getLogger(categoryName);
		}
		if (categoryName.equalsIgnoreCase(CaTIESConstants.LOGGER_CONCEPT_CODER))
		{
