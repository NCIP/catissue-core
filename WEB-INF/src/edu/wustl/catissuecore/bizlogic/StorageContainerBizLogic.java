...
//				Permissions.USE))
    ...
    public List getRelevantContainerList(long cpId, String specimenClass, boolean closeSession) throws DAOException
	{
		...
		String endQry = " and t1.IDENTIFIER = t6.STORAGE_CONTAINER_ID  "+
									" group by t6.STORAGE_CONTAINER_ID "+ 
										" order by co asc ";
		...
		String mainQuery = "(SELECT count(*) co, t1.IDENTIFIER, t1.NAME FROM CATISSUE_CONTAINER t1 , CATISSUE_STOR_CONT_SPEC_CLASS t6 " + " WHERE t1.IDENTIFIER IN (SELECT t2.STORAGE_CONTAINER_ID"
		...
		String defaultRestrictionQuery = "(SELECT  count(*) co, t1.IDENTIFIER, t1.NAME FROM CATISSUE_CONTAINER t1 , CATISSUE_STOR_CONT_SPEC_CLASS t6 "
