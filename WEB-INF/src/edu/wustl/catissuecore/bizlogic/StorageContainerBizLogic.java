            ...
            TreeDataInterface
{
        ...
        for (int i = 0; i < noOfContainers; i++)
        {
            ...
            try
            {
                SecurityManager.getInstance(this.getClass())
                        .insertAuthorizationData(null, protectionObjects,
                                getDynamicGroups(cont));
            }
            catch (SMException e)
            {
            ...
            UserNotAuthorizedException
    {
        ...
        // if parent container is not changed only the position is changed.
        {
            if (container.isPositionChanged())
            {
                ...
                Object[] whereColumnValue = {container.getParentContainer()
                        .getSystemIdentifier()};
                ...
                Logger.out
                        .debug("oldContainer.getParentContainer().getSystemIdentifier().longValue() : "
                                + oldContainer.getParentContainer()
                ...
                Logger.out
                        .debug("container.getParentContainer().getSystemIdentifier().longValue() : "
                                + container.getParentContainer()
                                        .getSystemIdentifier().longValue());
                Logger.out
                        .debug("oldContainer.getPositionDimensionOne().intValue() : "
                                + oldContainer.getPositionDimensionOne()
                                        .intValue());
                Logger.out
                        .debug("container.getPositionDimensionOne().intValue() : "
                                + container.getPositionDimensionOne()
                                        .intValue());
                Logger.out
                        .debug("oldContainer.getPositionDimensionTwo().intValue() : "
                                + oldContainer.getPositionDimensionTwo()
                                        .intValue());
                Logger.out
                        .debug("container.getPositionDimensionTwo().intValue() : "
     ...
     * @throws SMException
     */
    private void isDeAssignable(DAO dao, String privilegeName, Long[] objectIds, Long userId, String roleId, boolean assignToUser) throws DAOException, SMException
    {
        String[] selectColumnNames = {"parentContainer.systemIdentifier",
                "site.systemIdentifier"};
        String[] whereColumnNames = {"systemIdentifier"};
        List listOfSubElement = super.getRelatedObjects(dao,
                StorageContainer.class, selectColumnNames,
                whereColumnNames, objectIds);
        ...
        while (iterator.hasNext())
        {
            ...
            {
                permission = SecurityManager.getInstance(
                        StorageContainerBizLogic.class).checkPermission(
                        userName, className, containerObject.toString(), privilegeName);
            }
            else//If the privilege is assigned/deassigned to a user group.
            {
                permission = SecurityManager.getInstance(
                        StorageContainerBizLogic.class).checkPermission(
                        roleId, className, containerObject.toString());
            }
...
//        }
    ...
    // This is needed since now users can enter the values in the edit box
    private boolean validatePosition(StorageContainer parent,
    ...
    private boolean isContainerAvailable(DAO dao, StorageContainer current)
    {
        try
        {
            ...
            else
            {
                ...
                String[] whereColumnName1 = {"positionDimensionOne",
                        "positionDimensionTwo",
                ...
                Object[] whereColumnValue1 = {
                        current.getPositionDimensionOne(),
                        current.getPositionDimensionTwo(),
            ...
            String posOne, String posTwo)
    {
        try
        {
            ...
            int positionDimensionOne = (storageContainer
                    .getPositionDimensionOne() != null ? storageContainer
                    .getPositionDimensionOne().intValue() : -1);
            int positionDimensionTwo = (storageContainer
                    .getPositionDimensionTwo() != null ? storageContainer
            ...
            StorageContainer storageContainer, String posOne, String posTwo)
    {
        try
        {
            ...
            String[] selectColumnName = {"systemIdentifier"};
            String[] whereColumnName = {"positionDimensionOne",
                    "positionDimensionTwo", "storageContainer.systemIdentifier"}; //"storageContainer."+Constants.SYSTEM_IDENTIFIER
            String[] whereColumnCondition = {"=", "=", "="};
            ...
            SessionDataBean sessionDataBean) throws DAOException, SMException
    {
        ...
        if (list.size() != 0)
        {
            ...
            {
                boolean canUsePosition = isPositionAvailable(dao, pc,
