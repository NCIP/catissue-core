...
public class ApproveUserBizLogic extends DefaultBizLogic
{
            ...
            throws DAOException, UserNotAuthorizedException
    {
        ...
        list = dao.retrieve(Institution.class.getName(), "systemIdentifier",
                user.getInstitution().getSystemIdentifier());
        if (list.size() != 0)
        {
        ...
        list = dao.retrieve(SignUpUser.class.getName(), "emailAddress", user
                .getEmailAddress());
        if (list != null)
        {
        ...
        boolean emailStatus = email.sendmail(adminEmailAddress, csmUser
                .getEmailId(), null, technicalSupportEmailAddress, mailServer,
                subject, body);
