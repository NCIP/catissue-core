...
public class SiteBizLogic extends DefaultBizLogic {
	...
	protected void update(DAO dao, Object obj, Object oldObj,
		...
		dao.audit(site.getAddress(), oldSite.getAddress(), sessionDataBean,
				true);
	...
	private boolean isSiteOccupied(DAO dao, Site site) throws DAOException {
		...
		try {
			...
			throw new DAOException(
					"Error while checking site for presence of specimens");
		}
	...
	private void setCordinator(DAO dao, Site site) throws DAOException {
		Object object = dao.retrieve(User.class.getName(), site
	...
	protected boolean validate(Object obj, DAO dao, String operation)
		...
		if (site == null) {
			...
			throw new DAOException(ApplicationProperties.getValue(
					"domain.object.null.err.msg", message));
		}
