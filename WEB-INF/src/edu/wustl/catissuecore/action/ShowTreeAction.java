...
public class ShowTreeAction extends BaseAction
{
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		final String participantId = request.getParameter(Constants.CP_SEARCH_PARTICIPANT_ID);
		/**
		 ...
		 */
		final String isParticipantChanged = request.getParameter("particiantChnaged");
		...
		final String cpTitle = request.getParameter("cpTitle");
