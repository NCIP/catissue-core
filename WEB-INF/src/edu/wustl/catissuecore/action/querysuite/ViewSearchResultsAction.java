...
/**
 * This action is an applet action called from DiagrammaticViewApplet class when user clicks on search button of AddLimits.jsp 
 ...
 * These results are stored in session so that they can be retrieved at the time of loading of result's screen.
...
public class ViewSearchResultsAction extends BaseAppletAction
{
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		if (inputDataMap != null && !inputDataMap.isEmpty())
		{
			...
			String errorMessage = QueryModuleUtil.executeQuery(request, query);
