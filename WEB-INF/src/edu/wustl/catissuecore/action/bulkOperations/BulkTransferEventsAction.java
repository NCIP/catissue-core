...
public class BulkTransferEventsAction extends BulkOperationAction
{
	...
	{
		eventParametersForm.setFieldValue("ID_"+specimenId+"_CLASS", specimenRow.get(2).toString());
		eventParametersForm.setFieldValue("ID_"+specimenId+"_LABEL", specimenRow.get(1).toString());
		if(specimenRow.get(3).equals(""))
		{
			eventParametersForm.setFieldValue("ID_"+specimenId+"_FROMLOC", "Is virtually located");
		}
		else
		{
			eventParametersForm.setFieldValue("ID_"+specimenId+"_FROMLOC", specimenRow.get(3)+" ("+specimenRow.get(4)+","+specimenRow.get(5)+")");
		}
		
		eventParametersForm.setFieldValue("ID_"+specimenId+"_FROMLOCID", specimenRow.get(6).toString());
		eventParametersForm.setFieldValue("ID_"+specimenId+"_FROMLOCPOS1", specimenRow.get(4).toString());
		eventParametersForm.setFieldValue("ID_"+specimenId+"_FROMLOCPOS2", specimenRow.get(5).toString());
