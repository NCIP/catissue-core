...
public class CreateSpecimenAction extends SecureAction
{
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		else
		{
			...
			Object object = dao.retrieve(StorageContainer.class.getName(), new Long(createForm
					.getStorageContainer()));
			if (object != null)
			{
	...
	private long getCpId(DefaultBizLogic dao, Long scgId) throws BizLogicException
	{
		...
		String[] whereColumnCondition = {"="};
		List cpList = dao.retrieve(SpecimenCollectionGroup.class.getName(), selectColumnName,
	...
	private void setPageData3(HttpServletRequest request, CreateSpecimenForm form, String pageOf)
	{
		...
		String changeAction1 = "setFormAction('MakeParticipantEditable.do?" + Constants.EDITABLE
				+ "=" + !readOnlyForAll + "')";
