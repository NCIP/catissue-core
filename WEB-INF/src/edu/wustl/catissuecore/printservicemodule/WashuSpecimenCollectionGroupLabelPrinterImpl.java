		...
		if (abstractDomainObject instanceof SpecimenCollectionGroup)
		{
			...
			for (int cnt = 0; cnt < specimenList.size(); cnt++)
			{
				...
				if (obj.getCollectionStatus().equals(Constants.COLLECTION_STATUS_COLLECTED))
				{
					...
					{
						dataMap.
						put(PrintWebServiceConstants.SPECIMEN_CLASS, obj.getClassName());
					}
					if (obj.getSpecimenType() != null)
					{
						dataMap.
						put(PrintWebServiceConstants.SPECIMEN_TYPE, obj.getSpecimenType());
					}
					if (obj.getId() != null)
					{
						dataMap.
						put(PrintWebServiceConstants.SPECIMEN_IDENTIFIER, obj.getId()
								.toString());
					}
					if (label == null)
					{
					...
					{
						dataMap.
						put(PrintWebServiceConstants.SPECIMEN_TISSUE_SITE, CommonUtilities
								.toString(obj.
					...
					{
						dataMap.put(PrintWebServiceConstants.
								SPECIMEN_COMMENT, CommonUtilities
								.toString(obj.getComment()));
					}
					if (obj.getCreatedOn() != null)
					{
						dataMap.put(PrintWebServiceConstants.
								SPECIMEN_CREATED_ON, CommonUtilities
								.toString(obj.getCreatedOn()));
					}
					if (obj.getLineage() != null)
					{
						dataMap.put(PrintWebServiceConstants.SPECIMEN_LINEAGE,
								CommonUtilities
							...
							&& obj.getSpecimenPosition().getStorageContainer() != null)
					{
						...
						dataMap.put(PrintWebServiceConstants.
								SPECIMEN_POSITION_DIMENSION_ONE,
								CommonUtilities.toString(obj.getSpecimenPosition()
					...
					{
						dataMap.put(PrintWebServiceConstants.PATHOLOGICAL_STATUS,
								CommonUtilities
					...
					{
						dataMap.put(PrintWebServiceConstants.
								PARTICIPANT_PROTOCOL_IDENTIFIER,
