/*
 * $Id: AquaFix.java,v 1.1.2.1 2007/02/27 10:32:49 santosh_chandak Exp $
 *
...
public final class AquaFix {
     ...
     * {@link #install} method.
     */
    private AquaFix(JComboBox comboBox) {
     ...
     */
    public static AquaFix install(JComboBox comboBox) {
        if(comboBox == null) throw new IllegalArgumentException();
        return new AquaFix(comboBox);
    }
