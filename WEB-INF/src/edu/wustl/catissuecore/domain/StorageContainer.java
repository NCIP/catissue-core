...
public class StorageContainer extends AbstractDomainObject implements java.io.Serializable
{
	...
	public StorageContainer(StorageContainer oldContainer)
	{
		...
		storageContainerCapacity = new StorageContainerCapacity(oldContainer
	...
	public void setAllValues(AbstractActionForm abstractForm)
	{
		try
		{
			...
			Logger.out.debug("SC Domain : " + this.isFull + " :-: form.getIsFull() : "
					+ form.getIsFull());
			...
			storageContainerCapacity.setOneDimensionCapacity(new Integer(form
					.getOneDimensionCapacity()));
			storageContainerCapacity.setTwoDimensionCapacity(new Integer(form
			...
			if (!form.isAddOperation())
			{
				...
				{
					if (parentContainer.getSystemIdentifier().longValue() != form
