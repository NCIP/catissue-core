...
////		ListUserCriteria reqAllUsersEvent = new ListUserCriteria();
...
////			UserDetail oldUserDetails = getUserEvent.getUserDetails();
...
////			if (userUpdatedEvent.getStatus().equals(ErrorType.OK)) {
////				return true;
////			}
////		}
////		catch (Exception ex) {
...
////		if (event.getStatus().equals(ErrorType.OK)) {
