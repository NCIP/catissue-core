...
public class DistributionProtocolsController {
	...
	public List<DistributionProtocolDetail> getDistributionProtocols(
		...
		ListDpCriteria crit = new ListDpCriteria().maxResults(maxResults);		
	...
	public DistributionProtocolDetail getDistributionProtocol(@PathVariable Long id) {
		DistributionProtocolQueryCriteria crit = new DistributionProtocolQueryCriteria();
		crit.setId(id);
		
		ResponseEvent<DistributionProtocolDetail> resp = distributionProtocolSvc.getDistributionProtocol(getRequest(crit));
		resp.throwErrorIfUnsuccessful();
		return resp.getPayload();
	}
	...
	public DistributionProtocolDetail deleteDistributionProtocol(@PathVariable Long id) {
		...
		ResponseEvent<DistributionProtocolDetail> resp = distributionProtocolSvc.deleteDistributionProtocol(getRequest(crit));
		resp.throwErrorIfUnsuccessful();
		return resp.getPayload();
	}
