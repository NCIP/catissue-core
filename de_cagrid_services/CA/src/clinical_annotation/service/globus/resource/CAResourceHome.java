 ...
 * 
 */
public class CAResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(CAResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    CAResourceProperties props = new CAResourceProperties();
			CAResource resource = new CAResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, CAConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, CAConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		CAResource resource = (CAResource) super.find(key);
		return resource;
	}
     ...
     */
    public CAResource getAddressedResource() throws Exception {
        CAResource thisResource;
        thisResource = (CAResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}