/**
 * CAPortTypeSOAPBindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package clinical_annotation.stubs.bindings;

public class CAPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements clinical_annotation.stubs.CAPortType {
    ...
    public CAPortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public CAPortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public CAPortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings0() {
            ...
            qName = new javax.xml.namespace.QName("http://clinical_annotation/CA/types", ">CAReference");
            cachedSerQNames.add(qName);
            cls = clinical_annotation.stubs.types.CAReference.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://clinical_annotation/CA/CQLResultTypes", "PermissibleCQLObjectResults");
            cachedSerQNames.add(qName);
            cls = clinical_annotation.cqlresulttypes.PermissibleCQLObjectResults.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://clinical_annotation/CA", ">CAResourceProperties");
            cachedSerQNames.add(qName);
            cls = clinical_annotation.stubs.CAResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
