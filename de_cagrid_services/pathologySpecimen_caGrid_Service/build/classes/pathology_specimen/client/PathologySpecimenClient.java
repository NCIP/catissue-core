 ...
 */
public class PathologySpecimenClient extends PathologySpecimenClientBase
		implements
			PathologySpecimenI
{

	public PathologySpecimenClient(String url) throws MalformedURIException, RemoteException
	{
		this(url, null);
	}

	public PathologySpecimenClient(String url, GlobusCredential proxy)
			throws MalformedURIException, RemoteException
	{
		super(url, proxy);
	}

	public PathologySpecimenClient(EndpointReferenceType epr) throws MalformedURIException,
			RemoteException
	{
		this(epr, null);
	}

	public PathologySpecimenClient(EndpointReferenceType epr, GlobusCredential proxy)
			throws MalformedURIException, RemoteException
	{
		super(epr, proxy);
	}
	...
	{
		System.out.println(PathologySpecimenClient.class.getName() + " -url <service url>");
	}
	...
	public static void main(String[] args)
	{
		...
		try
		{
			if (!(args.length < 2))
			{
				...
				{
					PathologySpecimenClient client = new PathologySpecimenClient(args[1]);
