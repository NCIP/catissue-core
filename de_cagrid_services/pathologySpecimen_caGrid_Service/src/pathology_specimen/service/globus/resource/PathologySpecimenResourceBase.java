package pathology_specimen.service.globus.resource;
...
import pathology_specimen.common.PathologySpecimenConstants;
import pathology_specimen.stubs.PathologySpecimenResourceProperties;
 ...
 * 
 */
public abstract class PathologySpecimenResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(PathologySpecimenResourceBase.class);

	private PathologySpecimenResourceConfiguration configuration;
    ...
    public PathologySpecimenResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((PathologySpecimenResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(PathologySpecimenConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((PathologySpecimenResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(PathologySpecimenConstants.SERVICEMETADATA);
	...
	public PathologySpecimenResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (PathologySpecimenResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((PathologySpecimenResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((PathologySpecimenResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
