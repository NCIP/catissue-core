   ...
   "feedback": {
    ...
    "settings": {
      ...
      "notifications": {
        ...
        "email_order_distributed_desc": "Enable/disable notification email when specimens distributed.",
        "email_query_export_data": "Query Export Notification",
        "email_query_export_data_desc": "Enable/disable notification email when data exported from query module.",
        "email_query_share_query_folder": "Share Query Folder Notification",
        "email_query_share_query_folder_desc": "Enable/disable notification email when query folder is shared with another user.",
        "email_specimen_list_shared": "Share Specimen List Notification",
        "email_specimen_list_shared_desc": "Enable/disable notification email while specimen list is shared with another user.",
        "email_users_created": "User Creation Notification",
        "email_users_created_desc": "Enable/disable notification email when user is created.",
        "email_users_forgot_password_link": "Forgot Password Link Notification",
        "email_users_forgot_password_link_desc": "Enable/disable notification email to send the forgot password link.",
        "email_users_new_user_request": "New User Request Notification",
        "email_users_new_user_request_desc": "Enable/disable new user notification email to system administrator.",
        "email_users_passwd_changed": "Password Change Notification",
        "email_users_passwd_changed_desc": "Enable/disable notification email on password change.",
        "email_users_request_rejected": "User Request Rejected Notification",
        "email_users_request_rejected_desc": "Enable/disable notification email while user registration is rejected.",
        "email_users_role_updated": "Role Updated Notification",
        "email_users_role_updated_desc": "Enable/disable notification email while an user's role is updated.",
        "email_users_signed_up": "User Signup Notification",
        "email_users_signed_up_desc": "Enable/disable notification email when a new user signs up."
      }
    }
}
