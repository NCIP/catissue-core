   ...
   "feedback": {
    ...
    "settings": {
      ...
      "biospecimen": {
        ...
        "cp_coding_enabled_desc": "CP codding enabled",
        "mpi_format": "MPI Format",
        "mpi_format_desc": "Format in which the MPI(Master Patient Index) is to be auto-generated",
        "mpi_generator": "MPI Generator",
        "mpi_generator_desc": "Auto-generate the MPI values",
        "mpi_pattern": "MPI Pattern",
        "mpi_pattern_desc": "MPI pattern",
        "mpi_validator": "MPI Validator",
        "mpi_validator_desc": "Used to validate the MPI provided by the user matches the format specified",
        "mrn_restriction_enabled": "MRN Restriction Enabled",
        "mrn_restriction_enabled_desc": "Medical Registration Number Restriction Enabled",
        "participant_consent_dir": "Participant Consent Directory",
        "participant_consent_dir_desc": "Data directory to store participant consent data",
        "participant_uid_pattern": "Participant UID Pattern",
        "participant_uid_pattern_desc": "Pattern for participant UID",
        "participant_uid_validator": "Participant UID Validator",
        "participant_uid_validator_desc": "Validator for participant UID",
        ...
        "specimen_type_abbr_map_desc": "Specimen type abbreviation file",
        "spmn_path_status_abbr_map": "Specimen Path Status Abbreviation Map",
        "spmn_path_status_abbr_map_desc": "Specimen pathological status abbreviation file",
        ...
        "spr_dir_desc": "Data directory to store surgical pathology reports",
        "uid_mandatory": "UID Mandatory",
        "uid_mandatory_desc": "UID mandatory",
      ...
      "common": {
        ...
        "app_url_desc": "Application Url",
        "data_dir": "Data Directory",
        "data_dir_desc": "Data directory to store uploaded data",
        "feedback_enabled": "Feedback Suppport Enabled",
        "feedback_enabled_desc": "Feedback support enabled",
        "locale": "Locale",
        "locale_desc": "Locale",
        "support_email": "Feedback Support Email",
        "support_email_desc": "Feedback support email",
        "welcome_video_source": "Welcome Video Source",
        "welcome_video_source_desc": "Welcome video source for signup page like youtube, vimeo etc",
        "welcome_video_url": "Welcome Video Url",
        "welcome_video_url_desc": "Url for welcome video on signup page"
      },

      "email": {
        "title": "Email",
        "account_id": "Account Id",
        "account_id_desc": "Email account id",
        "account_password": "Account Password",
        "account_password_desc": "Email account password",
        "admin_email_id": "Admin Email Id",
        "admin_email_id_desc": "Admin email id",
        "auth_enabled": "Authentication Enabled",
        "auth_enabled_desc": "Email authentication enabled or not",
        "server_host": "Server Host",
        "server_host_desc": "Email server host",
        "server_port": "Server Port",
        "server_port_desc": "Email server port",
        "starttls_enabled": "StartTLS Enabled",
        "starttls_enabled_desc": "StartTLS enabled or not"
      },

      "notifications": {
        "title": "Notifications",
        "email_order_distributed": "Order Distribution Notification Enabled",
        "email_order_distributed_desc": "Enable/disable notification email while order distributed",
        "email_query_export_data": "Query Export Notification Enabled",
        "email_query_export_data_desc": "Enable/disable notification email while query data exported",
        "email_query_share_query_folder": "Query Folder Shared Notification Enabled",
        "email_query_share_query_folder_desc": "Enable/disable notification email while query folder shared with user",
        "email_specimen_list_shared": "Specimen List Shared Notification Enabled",
        "email_specimen_list_shared_desc": "Enable/disable notification email while specimen list shared with user",
        "email_users_created": "User Created Notification Enabled",
        "email_users_created_desc": "Enable/disable notification email while user is created/registered",
        "email_users_forgot_password_link": "Forgot Password Link Notification Enabled",
        "email_users_forgot_password_link_desc": "Enable/disable notification email to send forgot password link",
        "email_users_new_user_request": "New User Request Notification Enabled",
        "email_users_new_user_request_desc": "Enable/disable notification email for admin to send new user signup request",
        "email_users_passwd_changed": "User Password Changed Notification Enabled",
        "email_users_passwd_changed_desc": "Enable/disable notification email while user's password got changed",
        "email_users_request_rejected": "User's Request Rejected Notification Enabled",
        "email_users_request_rejected_desc": "Enable/disable notification email while user's registration request gets rejected",
        "email_users_role_updated": "User's Role Updated Notification Enabled",
        "email_users_role_updated_desc": "Enable/disable notification email while user's role updates",
        "email_users_signed_up": "User Signedup Notification Enabled",
        "email_users_signed_up_desc": "Enable/disable notification email while user signup"
      }
    }
}
