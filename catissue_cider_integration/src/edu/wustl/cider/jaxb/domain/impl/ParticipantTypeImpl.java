        ...
        extends edu.wustl.cider.jaxb.domain.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (state) {
                    case  3 :
                        if (("SCGCollection" == ___local)&&("" == ___uri)) {
                            _CollectionProtocolRegistration = ((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl) spawnChildFromEnterElement((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl.class), 4, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  3 :
                        _CollectionProtocolRegistration = ((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl) spawnChildFromLeaveElement((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl.class), 4, ___uri, ___local, ___qname));
                        return ;
                    case  0 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        _CollectionProtocolRegistration = ((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl) spawnChildFromEnterAttribute((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl.class), 4, ___uri, ___local, ___qname));
                        return ;
                    case  0 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        _CollectionProtocolRegistration = ((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl) spawnChildFromLeaveAttribute((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl.class), 4, ___uri, ___local, ___qname));
                        return ;
                    case  0 :
                ...
                try {
                    switch (state) {
                        case  1 :
                            ...
                            return ;
                        case  3 :
                            _CollectionProtocolRegistration = ((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl) spawnChildFromText((edu.wustl.cider.jaxb.domain.impl.CollectionProtocolRegistrationTypeImpl.class), 4, value));
                            return ;
                        case  0 :
