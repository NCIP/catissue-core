...
public class StorageContainerTypeImpl implements edu.wustl.cider.jaxb.domain.StorageContainerType, com.sun.xml.bind.JAXBObject, edu.wustl.cider.jaxb.domain.impl.runtime.UnmarshallableObject, edu.wustl.cider.jaxb.domain.impl.runtime.XMLSerializable, edu.wustl.cider.jaxb.domain.impl.runtime.ValidatableObject
{

    protected edu.wustl.cider.jaxb.domain.SiteType _Site;
    public final static java.lang.Class version = (edu.wustl.cider.jaxb.domain.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.wustl.cider.jaxb.domain.StorageContainerType.class);
    }

    public edu.wustl.cider.jaxb.domain.SiteType getSite() {
        return _Site;
    }

    public void setSite(edu.wustl.cider.jaxb.domain.SiteType value) {
        _Site = value;
    }
    ...
    public edu.wustl.cider.jaxb.domain.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.wustl.cider.jaxb.domain.impl.runtime.UnmarshallingContext context) {
        return new edu.wustl.cider.jaxb.domain.impl.StorageContainerTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (_Site!= null) {
            context.startElement("", "Site");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Site), "Site");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Site), "Site");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Site), "Site");
            context.endElement();
        }
    }
...
+"ed.SiteTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000"
...
+"001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0004Sitet\u0000\u0000q\u0000~\u0000\u001csr\u0000\"com.sun."
...
+"q\u0000~\u0000\rq\u0000~\u0000\u000fq\u0000~\u0000\u0012q\u0000~\u0000\"q\u0000~\u0000\u0005x"));
        ...
        extends edu.wustl.cider.jaxb.domain.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.wustl.cider.jaxb.domain.impl.StorageContainerTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Name" == ___local)&&("" == ___uri)) {
                            _Site = ((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl) spawnChildFromEnterElement((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
                        if (("Site" == ___local)&&("" == ___uri)) {
