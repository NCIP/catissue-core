...
public class SpecimenCharacteristicsTypeImpl implements edu.wustl.cider.jaxb.domain.SpecimenCharacteristicsType, com.sun.xml.bind.JAXBObject, edu.wustl.cider.jaxb.domain.impl.runtime.UnmarshallableObject, edu.wustl.cider.jaxb.domain.impl.runtime.XMLSerializable, edu.wustl.cider.jaxb.domain.impl.runtime.ValidatableObject
{

    protected java.lang.String _TissueSite;
    public final static java.lang.Class version = (edu.wustl.cider.jaxb.domain.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.wustl.cider.jaxb.domain.SpecimenCharacteristicsType.class);
    }

    public java.lang.String getTissueSite() {
        return _TissueSite;
    }

    public void setTissueSite(java.lang.String value) {
        _TissueSite = value;
    }
    ...
    public edu.wustl.cider.jaxb.domain.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.wustl.cider.jaxb.domain.impl.runtime.UnmarshallingContext context) {
        return new edu.wustl.cider.jaxb.domain.impl.SpecimenCharacteristicsTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.wustl.cider.jaxb.domain.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "TissueSite");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text((_TissueSite), "TissueSite");
...
+";xp\u0000\u0000\u0000\u0002\u0001pq\u0000~\u0000\tq\u0000~\u0000\u001fx"));
        ...
        extends edu.wustl.cider.jaxb.domain.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.wustl.cider.jaxb.domain.impl.SpecimenCharacteristicsTypeImpl.this;
        }
