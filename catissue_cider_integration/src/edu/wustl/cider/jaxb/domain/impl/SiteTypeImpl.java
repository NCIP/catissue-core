...
+"/ExpressionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\u000bq\u0000~\u0000>q\u0000~\u0000\u0005q\u0000~\u0000;q\u0000~\u0000!q\u0000~\u0000Gq\u0000~\u00009x"));
        }
        ...
        extends edu.wustl.cider.jaxb.domain.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (state) {
                    case  1 :
                        if (("email" == ___local)&&("" == ___uri)) {
                            _Coordinator = ((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl) spawnChildFromEnterElement((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _Coordinator = ((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl) spawnChildFromLeaveElement((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                    case  4 :
                        if (("name" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _Coordinator = ((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl) spawnChildFromEnterAttribute((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                    case  0 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _Coordinator = ((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl) spawnChildFromLeaveAttribute((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                    case  0 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            _Coordinator = ((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl) spawnChildFromText((edu.wustl.cider.jaxb.domain.impl.UserTypeImpl.class), 2, value));
                            return ;
                        case  3 :
                            eatText1(value);
                            state = 4;
