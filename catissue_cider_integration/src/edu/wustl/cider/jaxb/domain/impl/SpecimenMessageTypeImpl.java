...
+"sionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000:q\u0000~\u0000=q\u0000~\u0000\u0005q\u0000~\u00008q\u0000~\u0000\u000bq\u0000~\u0000\"q\u0000~\u0000Fx"));
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("CollectionProtocolRegistration" == ___local)&&("" == ___uri)) {
                            _Participant = ((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl) spawnChildFromEnterElement((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        _Participant = ((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl) spawnChildFromLeaveElement((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                    case  4 :
                        if (("messageTimeStamp" == ___local)&&("" == ___uri)) {
                            context.popAttributes();
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        return ;
                    case  1 :
                        _Participant = ((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl) spawnChildFromEnterAttribute((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        return ;
                    case  1 :
                        _Participant = ((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl) spawnChildFromLeaveAttribute((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            _Participant = ((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl) spawnChildFromText((edu.wustl.cider.jaxb.domain.impl.ParticipantTypeImpl.class), 2, value));
                            return ;
                    }
