...
<xsl:template match="/">
  <html>
    <head>
    <title>caTissue Suite Coding Style Violations</title>
    </head>
    <body bgcolor="#FFFFEF">
    ...
    <p><b>The following are violations of the caTissue Suite Coding-Style Standards: Take Corrective action Immediately !!!</b></p>
    <p/>
	<xsl:apply-templates/>
    </body>
  </html>
