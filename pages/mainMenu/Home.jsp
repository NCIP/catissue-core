...
<%@ page import="edu.wustl.catissuecore.util.global.Constants"%>
	...
	<%@ taglib uri="/WEB-INF/struts-html.tld" prefix="html" %>
		...
		<td height="20" class="mainMenuItemOver"
			...
			onclick="document.location.href='Home.do'"><html:link
			styleClass="mainMenuLink" page="/Home.do">
		...
		<td height="20" class="mainMenuItem"
			...
			onclick="document.location.href='/ManageAdministrativeData.do'"><html:link
			styleClass="mainMenuLink" page="/ManageAdministrativeData.do">
		...
		<td height="20" class="mainMenuItem"
			onmouseover="changeMenuStyle(this,'mainMenuItemOver'),showCursor()"
			onmouseout="changeMenuStyle(this,'mainMenuItem'),hideCursor()"
			onclick="document.location.href='/ManageBioSpecimen.do'"><html:link
			styleClass="mainMenuLink" page="/ManageBioSpecimen.do">
		...
		<td height="20" class="mainMenuItem"
			onmouseover="changeMenuStyle(this,'mainMenuItemOver'),showCursor()"
			onmouseout="changeMenuStyle(this,'mainMenuItem'),hideCursor()"
			onclick="document.location.href='/Search.do'"><html:link
			styleClass="mainMenuLink" page="/Search.do">
