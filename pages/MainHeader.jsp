	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="83%" align="right" valign="top"><img
				...
				<logic:notEmpty scope="session" name="<%=Constants.SESSION_DATA%>">
					<td width="15%" align="right" valign="top"><a
						...
						src="images/uIEnhancementImages/logout_button1.gif" name="Image1" width="86"
						height="19" id="Image1"
				...
				<logic:empty scope="session" name="<%=Constants.SESSION_DATA%>">
					<td width="15%" valign="top" align="right"><a
						...
						key="app.loginMessage" /></a> <img src="images/uIEnhancementImages/spacer.gif" width="10"
						height="10" align="absmiddle" /></td>
				</logic:empty>
			</tr>
		</table>
		</td>
