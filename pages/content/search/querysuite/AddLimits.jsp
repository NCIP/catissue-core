			...
			<tr bgcolor="#DFE9F3">
					...
					<tr height="35" valign="center">
					 <td width="2%" valign="center">&nbsp;</td>
						<td valign="center" width="6%"><html:button property="Button" disabled="true"><bean:message key="query.saveButton"/></html:button></td>
						<td  valign="center" align="left" width="75%"><html:button property="Button" onclick="viewSearchResults()"><bean:message key="query.searchButton"/></html:button></td>
						<td  align="right" valign="center" ><html:button property="Button" disabled="true"><bean:message key="query.previousButton"/></html:button></td>
