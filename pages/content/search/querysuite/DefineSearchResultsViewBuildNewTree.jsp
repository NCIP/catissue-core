...
<table border="0" width="100%" id="table3" height="100%" cellspacing="0" cellpadding="0">
	...
	<tr valign="top" height="5" >
		<td height="1%"  valign="top" colspan="5" class="defineResultsViewMessage" height="2%" width="100%"><html:button property="Button"><bean:message key="query.buildNewTree"/></html:button></td>
	</tr>
	<tr valign="top" height="5%" >										
