		  ...
		  <td>
			<table summary="" cellpadding="3" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="formField">
					<%
						String attributeAction = "javascript:callAction('AdvanceQuery.do?pageOf="+pageOf;
						if (aliasName != null)
				...
				<!--  ********************* MD Code ********************** -->	
					...
					<div>	
					  <%if (nextOperatorValue != null && (false == nextOperatorValue.equals(""))){
							...
							<%}%>
						<%}else{ %>					
							<%String andLink = "setPropertyValue('"+nextOperator+"','"+Constants.AND_JOIN_CONDITION+"');incrementCounter();callAction('AdvanceQuery.do?pageOf="+pageOf+"')"; %>
