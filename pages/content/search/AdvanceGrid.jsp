...
<table width="100%" valign="top">
	<tr valign="top">
		<td valign="top">
			...
			-->
			<div id="gridbox" width="600px" height="280px" style="border-left:solid 1px;border-right:solid 1px;border-top:solid 1px;border-bottom:solid 1px;background-color:white;overflow:hidden"></div>
		</td>
	</tr>
</table>
