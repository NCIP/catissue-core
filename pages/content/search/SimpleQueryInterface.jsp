...
<logic:notEqual name="pageOf" value="<%=Constants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
              ...
              <tr>
                ...
                <td width="90%" valign="bottom" class="td_color_bfdcf3" style="padding-top:4px;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td width="6%" valign="bottom" background="images/uIEnhancementImages/tab_bg.gif" ><html:link href="#" onclick="callSerachAction('CommonTab.do')" > <img src="images/uIEnhancementImages/tab_add_user1.jpg" alt="Add" width="57" height="22" border="0" /></html:link></td>
                      <td width="6%" valign="bottom" background="images/uIEnhancementImages/tab_bg.gif"><img src="images/uIEnhancementImages/tab_edit_user1.jpg" alt="Edit" width="59" height="22" border="0" /></td>
					<logic:equal name="pageOf" value="<%=Constants.PAGEOF_USER_ADMIN%>">
					   <td width="15%" valign="bottom" background="images/uIEnhancementImages/tab_bg.gif"><html:link page="/ApproveUserShow.do?pageNum=1&menuSelected=1" ><img src="images/uIEnhancementImages/tab_approve_user.jpg" alt="Approve New Users" width="139" height="22" border="0" /></html:link></td>
					   </logic:equal>
					   <logic:notEqual name="pageOf" value="<%=Constants.PAGEOF_USER_ADMIN%>">
		...
		<logic:equal name="pageOf" value="<%=Constants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
			<tr><td class="td_color_bfdcf3">&nbsp;</td></tr>			
				</logic:equal>
		<logic:equal name="pageOf" value="<%=Constants.PAGEOF_NEW_SPECIMEN%>">
			<tr><td class="td_color_bfdcf3">&nbsp;</td></tr>
		</logic:equal>
			          <tr>
            <td class="td_color_bfdcf3" style="padding-left:10px; padding-right:10px; padding-bottom:10px;"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              ...
              <tr class="tr_bg_blue1">
				...
				<td height="25" colspan="7" align="left" class="tr_bg_blue1"><span class="blue_ar_b">
				<bean:message key="<%=title%>" />
				</span></td>
					<logic:equal name="pageOf" value="<%=Constants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
					<%String addAction = "setPropertyValue('andOrOperation','true');"+
									"incrementCounter();callSerachAction('SimpleQueryInterfaceValidate.do?pageOf="+pageOf+"');"; 
					%>
					<td class="tr_bg_blue1" align="Right">
						<html:button property="addKeyValue" styleClass="blue_ar_b" onclick="<%=addAction%>">
				...
				<tr bgcolor="#f8fcff">
						<logic:equal name="pageOf" value="<%=Constants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
						<td class="black_arNew" width="5">
							<bean:message key="query.queryNumber" />
						</td>
						<td class="black_arNew">
						...
						<td class="black_arNew" colspan="1">
						...
						<td class="black_arNew" colspan="2">
							<label for="value" >
			...
			<logic:equal name="pageOf" value="<%=Constants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
				...
				<logic:equal name="pageOf" value="<%=Constants.PAGEOF_SIMPLE_QUERY_INTERFACE%>">
					...
					<td class="black_new" >
<!-- Mandar : 434 : for tooltip -->
						<html:select property="<%=attributeCondition%>" styleClass="formFieldSized8" styleId="<%=operatorId%>" size="1" onchange="<%=operatorFunction%>"
						 onmouseover="showTip(this.id)" onmouseout="hideTip(this.id)">
						<%
				...
				<td class="blue_ar_b" id="<%=columnID%>"  size=3>
				<!--  ********************* Mandar Code ********************** -->	
				...
				%>
					...
					<%
						...
						{
					%>
						<html:text styleClass="black_ar" size="15" styleId="<%=attributeValueID%>" property="<%=attributeValue%>" disabled="true"/>
					<%
						}
						else
						{
					%>
						<html:text styleClass="black_ar" size="15" styleId="<%=attributeValueID%>" property="<%=attributeValue%>" />
					<%
						}
					%>
					</td>
				...
				<tr class="td_color_F7F7F7">
							...
							<td align="right" colspan="10"  class="buttonbg">
								<%String searchAction = "callSerachAction('"+Constants.SIMPLE_SEARCH_ACTION+"')";%>
								<html:button styleClass="blue_ar_b" property="searchButton" onclick="<%=searchAction%>">
							...
							if(pageOf.equals(Constants.PAGEOF_SIMPLE_QUERY_INTERFACE))
							{
							String configAction = "callSerachAction('"+Constants.CONFIGURE_SIMPLE_QUERY_VALIDATE_ACTION+"?pageOf=pageOfSimpleQueryInterface')";%>
								
							
							&nbsp;&nbsp;|&nbsp;<span >
								<html:button styleClass="blue_ar_b" property="configureButton" onclick="<%=configAction%>">
									<bean:message  key="buttons.configure" />
								</html:button></span>
							&nbsp;&nbsp;|&nbsp;<span >
								<%String deleteAction = "decrementCounter();setPropertyValue('value(SimpleConditionsNode:"+(Integer.parseInt(noOfRows)-1)+"_Operator_operator)','');"+"callSerachAction('SimpleQueryInterface.do?pageOf="+pageOf+"');"; %>
								<html:button property="deleteValue" styleClass="blue_ar_b" onclick="deleteChecked('simpleQuery','SimpleQueryInterface.do?pageOf=<%=pageOf%>',document.forms[0].counter,'chk_',false,document.forms[0].deleteValue)"  disabled="true">
									<bean:message key="buttons.delete"/>
								</html:button></span>
							
							<%}%>
							&nbsp;&nbsp;|&nbsp;<span class="cancellink" ><html:link page="/ManageAdministrativeData.do" >
