...
<!-- New row two -->					
					...
					<tr>
						...
						<td class="formTitle" align="Right">
							<html:button property="deleteValue" styleClass="actionButton" onclick="deleteChecked('addMore','/catissuecore/StorageContainer.do?operation=add&pageOf=pageOfStorageContainer&status=true',document.forms[0].counter,'chk_')">
