                    ...
                    <tr>
                      ...
                      <td width="26%" align="right"><img src="images/uIEnhancementImages/table_title_corner2.gif" width="31" height="24" /></td>
								...
								<logic:equal name="pageOf"
										...
										<td width="97%" valign="top" class="td_color_bfdcf3" >&nbsp;</td>
								</logic:equal>
										...
										style="padding-top: 4px;">
											...
											<logic:equal name="operation"
												value='${requestScope.addforJSP}'>
													...
													src="images/uIEnhancementImages/tab_add_user.jpg" alt="Add" width="57"
													height="22" /></td>
													<td width="6%" valign="bottom"
													...
													<img src="images/uIEnhancementImages/tab_edit_user.jpg" alt="Edit" width="59"
														height="22" border="0" />
													</html:link></td>
											...
											<logic:equal name="operation"
													...
													height="22" hspace="1" onclick="editUser()" /></td>
													<td width="6%" valign="bottom"
													background="images/uIEnhancementImages/tab_bg.gif"><html:link
													page="/ApproveUserShow.do?pageNum=1&menuSelected=1"><img
													src="images/uIEnhancementImages/tab_approve_user.jpg" alt="Approve New Users"
													width="139" height="22" border="0"
													/></html:link></td>
											</logic:equal>
							...
							<td colspan="2" class="td_color_bfdcf3"
												...
												<tr>
													<td>
														...
														cellspacing="0" class="td_color_ffffff">
															<tr>
																<td class=" grey_ar_s"><img src="images/uIEnhancementImages/star.gif"
																alt="Mandatory" width="6" height="6" hspace="0" vspace="0" />
									...
									<tr>
										<td colspan="3" align="left">
											<div id="part_det">
												<table width="100%" border="0" cellpadding="3" cellspacing="0">
										<logic:equal name="pageOf"
											value='${pageOfApproveUser}'>
													<tr>
														<td align="right" colspan="3">
										<!-- action buttons begins -->
															<table cellpadding="0" cellspacing="0" border="0">
																<tr>
																	<td><a class="blue_ar_s_b"
																	href='${requestScope.backPage}'> <bean:message
																	key="buttons.approveUserHome" /> </a>&nbsp;</td>
														<logic:notEmpty name="prevpage">
																	<td>|&nbsp;<a class="blue_ar_s_b"
																	href='${requestScope.prevPageURL}'> <bean:message
																	key="approveUser.previous" /> </a>&nbsp;</td>
														</logic:notEmpty>
														<logic:notEmpty name="nextPage">
																	<td>|&nbsp;<a class="blue_ar_s_b"
																		href='${requestScope.nextPageURL}'> <bean:message
																		key="approveUser.next" /> </a>&nbsp;
																	</td>
														</logic:notEmpty>
																</tr>
															</table>
										<!-- action buttons end -->
													...
													<tr>
														<td>
															<table summary="" cellpadding="0" cellspacing="0" border="0">
																<tr>
																	<td><html:hidden property="operation" /> <html:hidden
																	property="submittedFor" /></td>
																</tr>
																<tr>
																	<td><html:hidden property="id" /> <html:hidden
																		property="csmUserId" /> <html:hidden
											...
											<!-- special   -->
													<tr>
														<td width="4" height="25" align="left" bgcolor="#f3f8fb"
														class="black_ar">&nbsp;</td>
											...
											<logic:notEqual name="pageOf"
												value='${requestScope.pageOfUserProfile}'>
														...
														src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6"
														hspace="0" vspace="0" /></span>
														</td>
														<td width="15%" align="left"><label
														for="confirmEmailAddress" class="black_ar"> <bean:message
														key="user.confirmemailAddress" /> </label>
														</td>
										...
										<logic:equal name="operation"
												...
												<tr>
													<td width="1%" align="left" class="black_ar"><span
														class="blue_ar_b"><img src="images/uIEnhancementImages/star.gif"
														alt="Mandatory" width="6" height="6" hspace="0" vspace="0" /></span></td>
													<td width="15%" align="left" class="black_ar"><label
												...
												<tr>
													...
													<td align="left" class="black_ar"><label for="street">
														<bean:message key="user.street" /> </label>
													</td>
													<td align="left"><html:text styleClass="black_ar"
													...
													<td align="left" class="black_ar"><label for="city">
														<bean:message key="user.city" /> </label>
													</td>
													<td align="left"><html:text styleClass="black_ar"
												...
												<tr>
													...
													<td align="left" class="black_ar"><label for="state">
														<bean:message key="user.state" /> </label>
													</td>
													...
													<td align="left" class="black_ar"><label for="zipCode">
														<bean:message key="user.zipCode" /> </label>
													</td>
													<td align="left"><html:text styleClass="black_ar"
												...
												<tr>
													...
													<td align="left" class="black_ar"><label for="country">
														<bean:message key="user.country" /> </label>
													</td>
													<td align="left" class="black_new"><autocomplete:AutoCompleteTag
												...
												<tr>
													...
													<td align="left" class="black_ar"><label for="faxNumber">
														<bean:message key="user.faxNumber" /> </label>
													</td>
													<td align="left"><html:text styleClass="black_ar"
													...
													<td align="left" class="smalllink"><logic:notEqual
														name="pageOf"
														value='${requestScope.pageOfSignUp}'>
												...
												<tr>
													...
													<td align="left" class="black_ar"><label
														...
														key="user.cancerResearchGroup" /> </label>
													</td>
													<td align="left" class="black_new"><autocomplete:AutoCompleteTag
								...
								<tr onclick="javascript:showHide('add_id')">
									<td align="left" class="tr_bg_blue1"><span
										...
										key="user.administrativeDetails.title" /></span>
									</td>
											...
											<logic:equal name="pageOf"
												...
												<tr>
													...
													<td width="16%" align="left" class="black_ar"><label
															...
															key="user.approveOperation" /> </label>
													</td>
												...
												<tr>
													...
													<td width="16%" align="left" class="black_ar"><label
														for="role"><bean:message key="user.role" /> </label>
													</td>
													<td width="83%" colspan="4" align="left" valign="top"
												...
												<tr>
													...
													<td colspan="4" align="left" valign="top"><label>
														...
														styleId="comments" property="comments" /> </label>
													</td>
												</tr>
											</logic:notEqual>
											</logic:notEqual>
