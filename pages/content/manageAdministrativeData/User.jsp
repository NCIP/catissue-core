                    ...
                    <tr>
                      ...
                      <td width="26%" align="right"><img src="images/uIEnhancementImages/table_title_corner2.gif" width="31" height="24" /></td>
						...
						<tr>
							<td colspan="2" class="td_color_bfdcf3"
								...
								<logic:equal name="operation" value='${requestScope.editforJSP}'>
													...
													<tr>
														...
														<td width="21%" align="left">
															<label>
															<html:text styleClass="black_ar" maxlength="255" size="30" styleId="emailAddress" property="emailAddress"
								...
								<logic:notEqual name="pageOf" value='${requestScope.pageOfUserProfile}'>
														...
														<td width="1%" align="left">
															<span class="blue_ar_b">
															<img src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6"
															hspace="0" vspace="0" /></span>
														</td>
														<td width="15%" align="left">
															<label for="confirmEmailAddress" class="black_ar">
																<bean:message key="user.confirmemailAddress" />
															</label>
														</td>
														<td width="21%" align="left">
															<html:text styleClass="black_ar" maxlength="255"			size="30" styleId="confirmEmailAddress"
								...
								<logic:equal name="pageOf" value='${pageOfApproveUser}'>
													<tr>
														<td width="1%" height="25" align="left" class="black_ar">
															<span class="blue_ar_b"><img src="images/uIEnhancementImages/star.gif"
								...
								<logic:equal name="pageOf" value='${requestScope.pageOfUserAdmin}'>
									...
									<tr class="td_color_F7F7F7">
										<td colspan="3" class="buttonbg"><html:submit
												...
												</html:submit> &nbsp;| <span class="cancellink">
							<logic:notEqual name="pageOf" value='${requestScope.pageOfSignUp}'>
												<html:link
							...
							<logic:equal name="pageOf" value='${requestScope.pageOfSignUp}'>
												<html:link
												page="/RedirectHome.do" styleClass="blue_ar_s_b">
													<bean:message key="buttons.cancel" />
												</html:link>
							</logic:equal>
												</span>
