...
<html:form action="<%=Constants.STORAGE_TYPE_ADD_ACTION%>">
	...
	<table summary="" cellpadding="3" cellspacing="0" border="0">
		...
		<tr>
			...
			<td class="formField">
				<html:text styleClass="formFieldSized" size="30" styleId="defaultTemperature" property="defaultTemperature"/>
				°C
			</td>
		</tr>
		...
		<tr>
			...
			<td class="formField">
					<html:text styleClass="formFieldSized" size="10" styleId="oneDimensionCapacity" property="oneDimensionCapacity"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="formField">
				<html:text styleClass="formFieldSized" size="10" styleId="twoDimensionCapacity" property="twoDimensionCapacity"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="formField">
				<html:text styleClass="formFieldSized" size="30" styleId="oneDimensionLabel" property="oneDimensionLabel"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="formField">
				<html:text styleClass="formFieldSized" size="30" styleId="twoDimensionLabel" property="twoDimensionLabel"/>
			</td>
		</tr>
