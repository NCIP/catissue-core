        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="whitetable_bg">
          <tr>
			   ...
			   <tr>
				...
				<logic:equal name="operation" value="add">
					  ...
					  <logic:equal name="operation" value="edit">
						<td width="6%" valign="bottom" background="images/uIEnhancementImages/tab_bg.gif" ><html:link page="/Site.do?operation=add&pageOf=pageOfSite&menuSelected=5"><img src="images/uIEnhancementImages/tab_add_user1.jpg" alt="Add" width="57" height="22" border ="0" /></html:link></td>
            ...
            <td colspan="2" class="td_color_bfdcf3" style="padding-left:10px; padding-right:10px; padding-bottom:10px;"><table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
			  ...
			  <tr>
                <td colspan="3" align="left" style="padding-top:10px; padding-bottom:15px;"><div id="part_det" >
					...
					<tr>
                          ...
                          <td width="15%" align="left" class="black_ar">
							...
							<td width="21%" align="left" class="black_ar">
                        ...
                        <tr>
                          ...
                          <td align="left" class="black_new">
								<html:select property="coordinatorId" styleClass="formFieldSizedNew" styleId="coordinatorId" size="1" onchange="onCoordinatorChange()"
							 onmouseover="showTip(this.id)" onmouseout="hideTip(this.id)">
								<html:options collection="userList" labelProperty="name" property="value"/>
							</html:select></td>
                          <td align="left" class="smalllink">
							<html:link href="#" styleId="newCoordinator" styleClass="blue_ar_s_b" onclick="addNewAction('SiteAddNew.do?addNewForwardTo=coordinator&forwardTo=site&addNewFor=coordinator')">
								<bean:message key="buttons.addNew" />
							</html:link></td>
                          <td align="left" class="black_ar">&nbsp;</td>
                          <td align="left" class="black_ar"><label for="emailAddress">
								<bean:message key="site.emailAddress" />
							</label></td>
                          <td align="left">
								<html:text styleClass="black_ar"  maxlength="255"  size="30" styleId="emailAddress" property="emailAddress" /></td>
                        ...
                        <tr>
                          ...
                          <td align="left"><html:text styleClass="black_ar"  maxlength="50"  size="30" styleId="street" property="street" /></td>
                          <td align="left" class="black_ar">&nbsp;</td>
                          <td align="left" class="black_ar"><span class="blue_ar_b"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6" hspace="0" vspace="0" /></span></td>
                          <td align="left" class="black_ar">
								<label for="city">
                          ...
                          <td align="left">
								<html:text styleClass="black_ar"  maxlength="50"  size="30" styleId="city" property="city" /></td>
                          <td align="left" valign="top">&nbsp;</td>
                        </tr>
						<tr>
                          <td align="left" class="black_ar"><span class="blue_ar_b"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6" hspace="0" vspace="0" /></span></td>
                          ...
                          <td align="left">
								<html:text styleClass="black_ar"  maxlength="30"  size="30" styleId="zipCode" property="zipCode" /></td>
                          <td align="left" valign="top">&nbsp;</td>
                        </tr>
                        <tr>
                          <td align="left" class="black_ar"><span class="blue_ar_b"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6" hspace="0" vspace="0" /></span></td>
                          ...
                          <td align="left">
								<html:text styleClass="black_ar"  maxlength="50"  size="30" styleId="phoneNumber" property="phoneNumber" /></td>
                          <td align="left" valign="top">&nbsp;</td>
                        </tr>
                        <tr>
                          <td align="left" class="black_ar">&nbsp;</td>
                          ...
                          <td align="left">
								<html:text styleClass="black_ar"  maxlength="50"  size="30" styleId="faxNumber" property="faxNumber" /></td>
                          ...
                          <td align="left" valign="top">&nbsp;</td>
							...
							<logic:notEqual name='${requestScope.operationForActivityStatus}' value='${requestScope.operationEdit}'>
