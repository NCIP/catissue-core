 ...
 <legend class="blue_ar_b legend_font_size"> <b>  View Image </b></legend>
						...
						<logic:equal name="imageDTO" property="imageType" value="aperio">
						  ...
						  <td width="17%" align="left" class="black_ar " >
									<a href="#" class="view"><span title="Download Image" style="vertical-align:top">View in WebScope(Web-Based Application)</span></a></td>
								</td>
							<td width="34%"/>
								<td width="1%" align="center" class="black_ar">
							<span class="blue_ar_b">
						  ...
						  <td width="17%" align="left" class="black_ar " >
									<a href="#" class="view"><span title="Download Image" style="vertical-align:top">View in ImageScope(Desktop Application)</span></a></td>
								</td>
							<td width="34%"/>
								<td width="1%" align="center" class="black_ar">
							<span class="blue_ar_b">
						  ...
						  <td width="17%" align="left" class="black_ar " >
									<a href="#" class="view"><span title="Download Image" style="vertical-align:top">Download Image</span><img name="download image" src="images/uIEnhancementImages/down.png" width="16" height="16" valign="bottom"/></a></td>
								</td>
							<td width="34%"/>
								<td width="1%" align="center" class="black_ar">
							<span class="blue_ar_b">
