...
<%!
	private String changeUnit(String specimenType, String subType)
	{
		...
		{
			if(subType.equals(Constants.FROZEN_TISSUE_SLIDE) || subType.equals(Constants.FIXED_TISSUE_BLOCK) || subType.equals(Constants.FROZEN_TISSUE_BLOCK) || subType.equals(Constants.NOT_SPECIFIED)  || subType.equals(Constants.FIXED_TISSUE_SLIDE))
...
<!--  Distributed Item begin here -->
				 <tr>
				    ...
				    <td class="formButtonField" align="Right">
						<html:button property="deleteValue" styleClass="actionButton" onclick="deleteChecked('addMore','Distribution.do?operation=<%=operation%>&pageOf=pageOfDistribution&status=true',document.forms[0].counter,'chk_',false)" disabled="true">
