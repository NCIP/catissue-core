...
<tr>
          <td align="left" class="tr_bg_blue1"><span class="blue_ar_b">&nbsp;Event Parameters &quot;<em>Procedure</em>&quot;</span></td>
        </tr>
        <tr>
...
<!-- Mandar : For url Start -->
                <tr>
                  ...
                  <td align="left"><span class="black_ar">
		  <html:text styleClass="black_ar" size="34" maxlength="255"  styleId="url" property="url" />
			</span>
		  </td>
                </tr>
<!-- Mandar : For url End -->
<!-- Mandar : For name Start -->
                <tr>
                  <td align="center" class="black_ar"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory Field" width="6" height="6" hspace="0" vspace="0" /></td>
                  <td align="left" class="black_ar"><LABEL for="name"><bean:message key="procedureeventparameters.entername"/></LABEL></td>
                  <td align="left"><span class="black_ar">
			<html:text styleClass="black_ar" size="34" maxlength="255" styleId="name" property="name" />
			</span>
		  </td>
                </tr>
<!-- Mandar : For name End -->
