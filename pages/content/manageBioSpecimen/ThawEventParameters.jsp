...
<%
		...
		Object obj = request.getAttribute("thawEventParametersForm");
		String currentEventParametersDate = "";
		ThawEventParametersForm form = null;
		if(obj != null && obj instanceof ThawEventParametersForm)
		{
			form = (ThawEventParametersForm)obj;
