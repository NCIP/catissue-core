...
<%
        ...
        String formName;
        String searchFormName = new String(Constants.THAW_EVENT_PARAMETERS_SEARCH_ACTION);
			...
			<td class="formField">
				 <div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
					<html:text styleClass="formDateSized" size="35" styleId="dateOfEvent" property="dateOfEvent" readonly="true"/>
						<a href="javascript:show_calendar('thawEventParametersForm.dateOfEvent','','','MM-DD-YYYY');">
