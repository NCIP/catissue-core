          ...
          <td colspan="4" class="showhide"><table width="100%" border="0" cellpadding="3" cellspacing="0">
				...
				<span class="grey_ar_s capitalized">[${datePattern}]</span>&nbsp;</td>
                  ...
                  <td align="left">&nbsp;&nbsp;
										  ...
										  <select id="timeInHours1" styleClass="black_ar" styleId="timeInHours1" size="1"> 
							   ...
							   <select id="timeInMinutes1" styleClass="black_ar" styleId="timeInMinutes1" size="1"> 
							  ...
							  <html:hidden property="timeInHours" value='${thawEventParametersForm.timeInHours}'/>
<html:hidden property="timeInMinutes"  value='${thawEventParametersForm.timeInMinutes}'/>
							  
							  </div>
						 	<script>
								window.dhx_globalImgPath="dhtmlx_suite/imgs/";
								var timeHr = new dhtmlXCombo("timeInHours1","timeInHours","100px");
								timeHr.setSize(60);
								if('${thawEventParametersForm.timeInHours}'!=0){
									timeHr.setComboValue('${thawEventParametersForm.timeInHours}');
								}
								timeHr.attachEvent("onChange", function(){
									document.getElementsByName("timeInHours")[0].value= timeHr.getSelectedValue();
								}); 
								var timeMinute = new dhtmlXCombo("timeInMinutes1","timeInMinutes","100px");
								timeMinute.setSize(60);
								if('${thawEventParametersForm.timeInMinutes}'!=0){
									timeMinute.setComboValue('${thawEventParametersForm.timeInMinutes}');
								}
