...
<%
        ...
        String formName;
        String searchFormName = new String(Constants.FIXED_EVENT_PARAMETERS_SEARCH_ACTION);
			...
			<td class="formField">
				 <div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
					<html:text styleClass="formDateSized" size="35" styleId="dateOfEvent" property="dateOfEvent" readonly="true"/>
						<a href="javascript:show_calendar('fixedEventParametersForm.dateOfEvent','','','MM-DD-YYYY');">
		...
		<tr>
			...
			<td class="formField">
				<html:select property="fixationType" styleClass="formFieldSized" styleId="fixationType" size="1">
					<html:options name="<%=Constants.FIXATIONLIST%>" labelName="<%=Constants.FIXATIONLIST%>" />
				</html:select>
			</td>
		</tr>
...
<!-- durationInMinutes -->		
		<tr>
			...
			<td class="formField">
				<html:text styleClass="formDateSized" size="35" styleId="durationInMinutes" property="durationInMinutes" />		
			</td>
		</tr>
