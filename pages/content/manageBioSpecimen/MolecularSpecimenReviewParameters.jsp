...
<%
        ...
        String formName;
        String searchFormName = new String(Constants.MOLECULAR_SPECIMEN_REVIEW_PARAMETERS_SEARCH_ACTION);
			...
			<table summary="" cellpadding="3" cellspacing="0" border="0">
				<tr>
					<td class="formTitle" height="20" colspan="3">
						<bean:message key="molecularspecimenreviewparameters.searchTitle"/>
					</td>
				</tr>	
			...
			<td class="formField">
				 <div id="overDiv" style="position:absolute; visibility:hidden; z-index:1000;"></div>
					<html:text styleClass="formDateSized" size="35" styleId="dateOfEvent" property="dateOfEvent" readonly="true"/>
						<a href="javascript:show_calendar('molecularSpecimenReviewParametersForm.dateOfEvent','','','MM-DD-YYYY');">
