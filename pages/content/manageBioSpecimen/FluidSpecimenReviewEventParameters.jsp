...
<tr>
          <td align="left" class="tr_bg_blue1"><span class="blue_ar_b">&nbsp;Event Parameters &quot;<em>FluidSpecimenReview</em>&quot;</span></td>
        </tr>
        <tr>
...
<!-- Mandar : For cellcount Start -->
			...
			<bean:message key="fluidspecimenrevieweventparameters.cellcount"/> 
                  ...
                  <td align="left">
			<html:text styleClass="black_ar"  maxlength="10" size="35" styleId="cellCount" property="cellCount" />
		  </td>
                </tr>
