...
<html:hidden property="timeInHours" value='${fluidSpecimenReviewEventParametersForm.timeInHours}'/>
<html:hidden property="timeInMinutes"  value='${fluidSpecimenReviewEventParametersForm.timeInMinutes}'/>
							 ...
							 window.dhx_globalImgPath="dhtmlxSuite_v35/dhtmlxWindows/codebase/imgs/";
							  ...
							  if('${fluidSpecimenReviewEventParametersForm.timeInHours}'!=0){
								timeHr.setComboValue('${fluidSpecimenReviewEventParametersForm.timeInHours}');
							  }
							  ...
							  if('${fluidSpecimenReviewEventParametersForm.timeInMinutes}'!=0){
								timeMinute.setComboValue('${fluidSpecimenReviewEventParametersForm.timeInMinutes}');
							  }
