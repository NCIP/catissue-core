...
<%
		...
		Object obj = request.getAttribute("embeddedEventParametersForm");
		String currentEventParametersDate = ""; 
		EmbeddedEventParametersForm form = null;
		if(obj != null && obj instanceof EmbeddedEventParametersForm)
		{
			form = (EmbeddedEventParametersForm)obj;
...
<html:form action="<%=Constants.EMBEDDED_EVENT_PARAMETERS_ADD_ACTION%>">


	<!-- NEW EmbeddedEventParameter REGISTRATION BEGINS-->
	<tr>
	<td>
		...
		<tr>
			<td class="formTitle" height="20" colspan="3">
				<logic:equal name="operation" value="<%=Constants.ADD%>">
					<bean:message key="embeddedeventparameters.title"/>
				</logic:equal>
				<logic:equal name="operation" value="<%=Constants.EDIT%>">
					<bean:message key="embeddedeventparameters.EDITtitle"/>
				</logic:equal>
			</td>
		</tr>

		<!-- Name of the embeddedEventParameters -->
<!-- User -->		
		<tr>
...
<!-- embeddingMedium -->		
		<tr>
			...
			<td class="formRequiredLabel">
				<label for="type">
					<bean:message key="embeddedeventparameters.embeddingMedium"/> 
				</label>
			</td>
			<td class="formField">
					 <autocomplete:AutoCompleteTag property="embeddingMedium"
						  optionsList = "<%=request.getAttribute(Constants.EMBEDDING_MEDIUM_LIST)%>"
						  initialValue="<%=form.getEmbeddingMedium()%>"
				    />	
			</td>
		</tr>
