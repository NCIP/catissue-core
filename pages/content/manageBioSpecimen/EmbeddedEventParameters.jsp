...
<html:hidden property="timeInHours" value='${embeddedEventParametersForm.timeInHours}'/>
<html:hidden property="timeInMinutes"  value='${embeddedEventParametersForm.timeInMinutes}'/>
							 ...
							 window.dhx_globalImgPath="dhtmlx_suite/imgs/";
							  ...
							  if('${embeddedEventParametersForm.timeInHours}'!=0){
								timeHr.setComboValue('${embeddedEventParametersForm.timeInHours}');
							  }
							  ...
							  if('${embeddedEventParametersForm.timeInMinutes}'!=0){
								timeMinute.setComboValue('${embeddedEventParametersForm.timeInMinutes}');
							  }
                ...
                <tr>
                  ...
                  <td align="left" colspan="4" class="black_ar">
						  
					  <div style="width:100%"  class="black_ar"><div style="float:left;">
						<select id="embeddingMedium1" styleClass="black_ar" styleId="embeddingMedium1" size="1"> 
						<logic:iterate id="embeddingMediumList" name="embeddingMediumList">
								
									<option value="<bean:write name='embeddingMediumList' property='value'/>"><bean:write name="embeddingMediumList" property="name"/></option>
								
							</logic:iterate>
						</select></div>
<html:hidden property="embeddingMedium" value="${embeddedEventParametersForm.embeddingMedium}"/>

						</div>
								<script>
							  var embeddingMedium = new dhtmlXCombo("embeddingMedium1","embeddingMedium1","100px");
							  embeddingMedium.setSize(225);
							  embeddingMedium.enableFilteringMode(true);
							  if("${embeddedEventParametersForm.embeddingMedium}"!=0){
								embeddingMedium.setComboValue("${embeddedEventParametersForm.embeddingMedium}");
							  }
							  embeddingMedium.attachEvent("onChange", function(){
								document.getElementsByName("embeddingMedium")[0].value= embeddingMedium.getSelectedValue();
							  });  
