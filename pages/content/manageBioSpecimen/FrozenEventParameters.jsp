...
<%
        ...
        String formName;
        String searchFormName = new String(Constants.FROZEN_EVENT_PARAMETERS_SEARCH_ACTION);
				...
				<tr>
					...
					<td class="formRequiredLabel">
						<label for="systemIdentifier">
							<bean:message key="frozenEventParameters.systemIdentifier"/>
						</label>
					</td>
					<td class="formField">
...
<!-- User -->		
		<tr>
			...
			<td class="formRequiredLabel">
				<label for="type">
					<bean:message key="frozenEventParameters.user"/> 
				</label>
			</td>
			<td class="formField">
