		...
		<td width="15%" valign="top">
			<table border="0" width="175" height="100%">
				<tr height="<%=cpAndParticipantViewFrameHeight%>">
					<td>				
					<iframe id="<%=Constants.CP_AND_PARTICIPANT_VIEW%>" src="<%=Constants.SHOW_CP_AND_PARTICIPANTS_ACTION%>?pageOf=<%=Constants.PAGE_OF_CP_QUERY_RESULTS%>" scrolling="no" frameborder="0" width="100%" height="<%=frame1Ysize%>" marginheight=0 marginwidth=0>
				...
				<tr>
					...
					<iframe id="<%=Constants.CP_TREE_VIEW%>" src="<%=Constants.CP_TREE_VIEW_ACTION%>" scrolling="no" frameborder="0" width="100%" height="<%=frame2Ysize%>" marginheight=0 marginwidth=0 valign="top">
						Your Browser doesn't support IFrames.
					</iframe>
