...
<table border="0" height="100%" width="100%" cellpadding="0" cellspacing="0">
	<tr height="100%">
		<td width="15%">
			<table border="0" height="100%" width="175">
				<tr height="45%">
					<td>				
				...
				<tr height="55%">
					...
					<iframe id="<%=Constants.CP_TREE_VIEW%>" src="<%=Constants.CP_TREE_VIEW_ACTION%>" scrolling="no" frameborder="0" width="175" height="<%=frame2Ysize%>" marginheight=0 marginwidth=0>
						Your Browser doesn't support IFrames.
					</iframe>
