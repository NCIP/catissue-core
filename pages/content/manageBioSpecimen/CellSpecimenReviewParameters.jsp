...
<html:hidden property="timeInHours" value='${cellSpecimenReviewParametersForm.timeInHours}'/>
<html:hidden property="timeInMinutes"  value='${cellSpecimenReviewParametersForm.timeInMinutes}'/>
							 ...
							 window.dhx_globalImgPath="dhtmlx_suite/imgs/";
							  ...
							  if('${cellSpecimenReviewParametersForm.timeInHours}'!=0){
								timeHr.setComboValue('${cellSpecimenReviewParametersForm.timeInHours}');
							  }
							  ...
							  if('${cellSpecimenReviewParametersForm.timeInMinutes}'!=0){
								timeMinute.setComboValue('${cellSpecimenReviewParametersForm.timeInMinutes}');
							  }
