...
function createNewCPR(){
    ...
    if(dhxWins.window("registerCPRPopUP")==null){
        ...
        div.innerHTML = "  <div id='errorMsg' style='display:none;min-height:18px;'></div> <div style='width:100%; height:85px'><div class='black_ar windowElementPaddingLeft  windowElementPaddingtop'>  <div style='float:left;'><b>Collection Protocol</b> <div id='popupCpList' style='margin-top:4px;'> </div></div>  <div style='float:left; margin-left: 21px;'> <b>Participant Protocol ID</b><div style='margin-top:4px;'><input type='text' id='popupPPID' style = 'font-size: 12px;width:148px;'/> <br><span id='egAutogeneratedString' style='font-size: 9px;color: #808080;  font-size: 9px;font-style: italic;display:none;'>e.g of auto generated PPID</span></div></div>  <div style='float:left;margin-left: 21px;'><b>Registration Date</b> <div style='margin-top:4px;'><input type='text' id='popupCPRDate' style = 'font-size: 12px;'/></div></div> </div></div>"
        
        +"<div><div class='black_ar windowElementPaddingLeft'>"+
        
        "<input type='button'  value='Register' onClick='registerParticipant()' style='margin-left:164px;margin-top:16px;'> <input type='button'  value='Cancel'  onClick='closeMultipleCprWindow()' style='margin-left:12px;margin-top:16px;'></div></div>";
