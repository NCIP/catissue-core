...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable" >
  <tr>
    <td class="td_color_bfdcf3"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="td_table_head"><span class="wh_ar_b"><bean:message key="cpbasedentry.specimenevents"/></span></td>
        <td><img src="images/uIEnhancementImages/table_title_corner2.gif" alt="Page Title - Specimen Events" width="31" height="24" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td class="tablepadding"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td valign="bottom"><a href="CreateSpecimen.do?operation=add&pageOf=pageOfDeriveSpecimen&virtualLocated=true"><img src="images/uIEnhancementImages/tab_derive2.gif" alt="Derive" width="56" height="22" /></a></td>
      ...
      <table width="100%" border="0" cellpadding="3" cellspacing="0" class="whitetable_bg">
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellpadding="3" cellspacing="0">
             <tr>
              ...
              <td width="15%" align="left" class="black_ar"><bean:message key="specimen.details.label"/></td>
              <td align="left" valign="middle" width="84%">
                    ...
                    <td valign="middle" nowrap><span class="black_ar">
                      ...
                      <logic:equal name="quickEventsForm" property="checkedButton" value="1">
								<html:text styleClass="black_ar"  maxlength="50"  size="20" styleId="specimenLabel" 
									property="specimenLabel" disabled="false" />
					        </logic:equal>
                        ...
                        <logic:equal name="quickEventsForm" property="checkedButton" value="1">
							    <html:text styleClass="black_ar"  maxlength="50"  size="20" styleId="barcode"
									property="barCode" disabled="true" />
						</logic:equal>
						<logic:equal name="quickEventsForm" property="checkedButton" value="2">
						    <html:text styleClass="black_ar"  maxlength="50"  size="20" styleId="barcode" 
								property="barCode" disabled="false" />
						</logic:equal>
                      </span></td>
                ...
                <tr>
                  ...
                  <td align="left" class="black_ar"><bean:message key="eventparameters.event"/></td>
        ...
        <tr>
          <td class="dividerline" >&nbsp;
	           <html:button property="quickEventsButton" onclick="onParameterChange()" styleClass="blue_ar_b">
