...
<tr>
          <td align="left" class="tr_bg_blue1"><span class="blue_ar_b">&nbsp;Event Parameters &quot;<em>Tissue Specimen Review</em>&quot;</span></td>
        </tr>
        <tr>
...
<!-- Mandar : For neoplasticcellularitypercentage Start -->
		<tr>
                  ...
                  <td class="black_ar" align="left" valign="top" width=23%><label for="type"><bean:message key="tissuespecimenrevieweventparameters.neoplasticcellularitypercentage"/></label></td>
                  <td align="left">
...
<!-- Mandar : For necrosispercentage Start -->
                <tr>
                  <td class="black_ar" align="center">&nbsp;</td>
                  <td class="black_ar" align="left" valign="top"><label for="necrosispercentage"><bean:message key="tissuespecimenrevieweventparameters.necrosispercentage"/></label></td>
                  <td align="left">
		  <html:text styleClass="black_ar" maxlength="10"  size="30" styleId="necrosisPercentage" property="necrosisPercentage" />
		  </td>
                </tr>
 <!-- Mandar : For necrosispercentage End -->
<!-- Mandar : For lymphocyticpercentage Start -->
                <tr>
                  <td class="black_ar" align="center">&nbsp;</td>
                  <td class="black_ar" align="left" valign="top">
		  <label for="necrosispercentage">
			<bean:message key="tissuespecimenrevieweventparameters.lymphocyticpercentage"/>
		  </label>
		  </td>
                  <td align="left">
		  <html:text styleClass="black_ar" maxlength="10"  size="30" styleId="lymphocyticPercentage" property="lymphocyticPercentage" />
		  </td>
                </tr>
 <!-- Mandar : For lymphocyticpercentage End -->
<!-- Mandar : For totalcellularitypercentage Start -->
                <tr>
                  <td class="black_ar" align="center">&nbsp;</td>
                  <td class="black_ar" align="left" valign="top">
		  <label for="necrosispercentage">
			<bean:message key="tissuespecimenrevieweventparameters.totalcellularitypercentage"/>
                  ...
                  <td align="left">
		  <html:text styleClass="black_ar" maxlength="10"  size="30" styleId="totalCellularityPercentage" property="totalCellularityPercentage" />
		  </td>
                </tr>
 <!-- Mandar : For totalcellularitypercentage End -->
<!-- Mandar : For histologicalQuality Start -->
                <tr>
                  <td class="black_ar" align="center">&nbsp;</td>
                  <td class="black_ar" align="left" valign="top">
		  <label for="necrosispercentage">
 ...
 <!-- Mandar : For histologicalQuality End -->
