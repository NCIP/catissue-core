...
<%
		...
		Object obj = request.getAttribute("tissueSpecimenReviewEventParametersForm");
		String currentEventParametersDate = ""; 
		TissueSpecimenReviewEventParametersForm form = null;
		if(obj != null && obj instanceof TissueSpecimenReviewEventParametersForm)
		{
			form = (TissueSpecimenReviewEventParametersForm)obj;
		...
		<tr>
			...
			<td class="formField">
			 <autocomplete:AutoCompleteTag property="histologicalQuality"
						  optionsList = "<%=request.getAttribute(Constants.HISTOLOGICAL_QUALITY_LIST)%>"
						  initialValue="<%=form.getHistologicalQuality()%>"
				    />	
			</td>
		</tr>
