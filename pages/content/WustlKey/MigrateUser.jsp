			...
			<table width="65%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="84%" align="left"><label>
                   <html:text styleClass="black_ar" maxlength="255"  size="30" styleId="migratedLoginName" property="migratedLoginName"/>
          ...
          <td align="left" class="showhide" >
				<table width="65%" border="0" cellpadding="0" cellspacing="0">
					<tr>
					    ...
					    <td width="84%" align="left"><label>
						 <html:password styleClass="black_ar" maxlength="255"  size="30" styleId="migratedPassword" property="migratedPassword"/>
						</label></td>
				</tr>
         </table>
	 </td>
