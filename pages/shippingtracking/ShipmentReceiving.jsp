											...
											<td align="left" >
												<table border="0" cellpadding="3" cellspacing="2">
													<tr>
										                  ...
										                  <td align="left" valign="top" class="grey_ar"><c:out value="${shipmentReceivingForm.label}"/>
										                  ...
										                  <td align="left" valign="top" class="grey_ar"><c:out value="${shipmentReceivingForm.barcode}"/>
													...
													<tr>
														  ...
														  <td align="left" valign="top" class="grey_ar">
                									...
                									<tr>
														...
														<td align="left" valign="top" class="grey_ar"><c:out value="${shipmentReceivingForm.senderContactPersonName}"/>
														...
														<td align="left" valign="top" class="grey_ar"><c:out value="${shipmentReceivingForm.receiverContactPersonName}"/>
													...
													<tr>
										                  ...
										                  <td align="left" valign="top" class="grey_ar"><label>
											...
											<tr>
												<td align="left" valign="top">
													<table width="100%" border="0" cellpadding="4" cellspacing="0" >
									           			<tr>
															<td height="25" colspan="6"  class="tableheading"><span class="black_ar_b">&nbsp;
														...
														<logic:iterate id="specimenItem" name="shipmentReceivingForm" property="specimenCollection">
									                  	<tr>
																...
																<td class="grey_ar" width="15%">
																	<b><c:out value="${specimenItem.label}"/>
																	<html:hidden name="specimenItem" property="label" indexed="true" /></b>
																</td>
																<td class="grey_ar" width="15%">
																...
																<td class="black_ar" width="15%">
																	...
																	<html:select property="<%=storageLocSelectName%>" styleId="<%=storageLocSelectId%>" styleClass="black_ar" onchange="onStorageRadioClickInSpecimen(this)" value="<%=(String)form.getSpecimenDetails(storageLocSelectId)%>">
																	...
																	<jsp:useBean id="spManualDivName" type="java.lang.String"/>
																		...
																		<table cellpadding="0" cellspacing="0" border="0" >
																				...
																				+ "&" + Constants.CAN_HOLD_COLLECTION_PROTOCOL +"=" + collectionProtocolId%></c:set>
																						...
																						<c:set var="functionCall">mapButtonClickedOnReceiveShipment('<%=frameUrl%>','newSpecimenPage',<%=selectedContainerId%>)</c:set>
																						...
																						<html:button styleClass="blue_ar" property="<%=buttonName%>" onclick="<%=functionCall%>" disabled= "false">
												...
												<td align="left" valign="top">
													<table width="100%" border="0" cellpadding="4" cellspacing="0" class="whitetable_bg">
														...
														<tr class="subtd">
											                ...
											                <td width="130"><b><bean:message key="shipment.barcode" bundle="msg.shippingtracking"/></b></td>
														...
														<logic:iterate id="containerItem" name="shipmentReceivingForm" property="containerCollection" >
															<tr>
																...
																<td class="grey_ar" width="15%"><c:out value="${containerItem.barcode}"/>
