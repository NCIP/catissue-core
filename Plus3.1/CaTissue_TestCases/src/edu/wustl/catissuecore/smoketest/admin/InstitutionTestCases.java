...
public class InstitutionTestCases extends CaTissueSuiteSmokeBaseTest
{
	...
	public void testInstitutionAdd()
	{
		...
		DataObject dataObject = TestCaseDataUtil.getDataObject("testInstitutionAdd");
...
//		TestCaseUtility.setNameObjectMap("Institution", institution);
	...
	{
		DataObject dataObject = TestCaseDataUtil.getDataObject("testInstitutionAddWithSameName");
		String[] arr = dataObject.getValues();
		InstitutionForm institutionForm = new InstitutionForm();
		institutionForm.setName(arr[0]);
		institutionForm.setOperation("add");
