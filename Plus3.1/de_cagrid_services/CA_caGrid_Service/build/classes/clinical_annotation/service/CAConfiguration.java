package clinical_annotation.service;
 ...
 * 
 */
public class CAConfiguration implements ServiceConfiguration {

	public static CAConfiguration  configuration = null;

	public static CAConfiguration getConfiguration() throws Exception {
		if (CAConfiguration.configuration != null) {
		...
		try {
			...
			CAConfiguration.configuration = (CAConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
