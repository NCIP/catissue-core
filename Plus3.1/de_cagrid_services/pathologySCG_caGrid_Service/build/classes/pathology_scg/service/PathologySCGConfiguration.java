 ...
 * 
 */
public class PathologySCGConfiguration implements ServiceConfiguration {

	public static PathologySCGConfiguration  configuration = null;

	public static PathologySCGConfiguration getConfiguration() throws Exception {
		if (PathologySCGConfiguration.configuration != null) {
			return PathologySCGConfiguration.configuration;
		}
		...
		try {
			...
			PathologySCGConfiguration.configuration = (PathologySCGConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
