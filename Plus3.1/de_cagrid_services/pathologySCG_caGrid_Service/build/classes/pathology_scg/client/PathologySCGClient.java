 ...
 */
public class PathologySCGClient extends PathologySCGClientBase implements PathologySCGI
{

	public PathologySCGClient(String url) throws MalformedURIException, RemoteException
	{
		this(url, null);
	}

	public PathologySCGClient(String url, GlobusCredential proxy) throws MalformedURIException,
			RemoteException
	{
		super(url, proxy);
	}

	public PathologySCGClient(EndpointReferenceType epr) throws MalformedURIException,
			RemoteException
	{
		this(epr, null);
	}

	public PathologySCGClient(EndpointReferenceType epr, GlobusCredential proxy)
	...
	{
		System.out.println(PathologySCGClient.class.getName() + " -url <service url>");
	}
	...
	public static void main(String[] args)
	{
		...
		try
		{
			if (!(args.length < 2))
			{
				...
				{
					PathologySCGClient client = new PathologySCGClient(args[1]);
