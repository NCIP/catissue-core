...
import pathology_scg.service.PathologySCGConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class PathologySCGResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(PathologySCGResourceBase.class);

	private PathologySCGResourceConfiguration configuration;
    ...
    public PathologySCGResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((PathologySCGResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(PathologySCGConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((PathologySCGResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(PathologySCGConstants.SERVICEMETADATA);
	...
	public PathologySCGResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (PathologySCGResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((PathologySCGResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((PathologySCGResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
