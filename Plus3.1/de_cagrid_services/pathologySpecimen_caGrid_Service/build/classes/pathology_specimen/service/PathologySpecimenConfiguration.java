 ...
 * 
 */
public class PathologySpecimenConfiguration implements ServiceConfiguration {

	public static PathologySpecimenConfiguration  configuration = null;

	public static PathologySpecimenConfiguration getConfiguration() throws Exception {
		if (PathologySpecimenConfiguration.configuration != null) {
			return PathologySpecimenConfiguration.configuration;
		}
		...
		try {
			...
			PathologySpecimenConfiguration.configuration = (PathologySpecimenConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
