...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u0000$edu.wus"
+"tl.cider.jaxb.domain.SiteTypet\u0000+http://java.sun.com/jaxb/xjc"
...
+"ttp://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0004Sitet\u0000"
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        _Site = ((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl) spawnChildFromLeaveElement((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _Site = ((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl) spawnChildFromEnterAttribute((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _Site = ((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl) spawnChildFromLeaveAttribute((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl.class), 2, ___uri, ___local, ___qname));
                        return ;
                    case  3 :
                ...
                try {
                    switch (state) {
                        case  0 :
                            ...
                            continue outer;
                        case  1 :
                            _Site = ((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl) spawnChildFromText((edu.wustl.cider.jaxb.domain.impl.SiteTypeImpl.class), 2, value));
                            return ;
                        case  3 :
