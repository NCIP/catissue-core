...
public class AddToMyListTestCases extends CaTissueSuiteBaseTest
{
	...
	public void testSpecimenAddToMyList()
	{
		try
		{
			...
			addRequestParameter("pageOf", "cpChildSubmit");
			actionPerform();
			System.out.println("Before: testSpecimenAddToMyList ");
			System.out.println(getActualForward());
			setRequestPathInfo(getActualForward());
			...
			verifyNoActionErrors();
			System.out.println("After: testSpecimenAddToMyList Success");
		}
		catch (Exception exp)
		{
			exp.printStackTrace();
			System.out.println("Error : testSpecimenAddToMyList: " + exp.getMessage());
		}
