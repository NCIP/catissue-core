...
//
//
//public class StorageContainerBizTestCases extends CaTissueApplicationService{
...
//	    	StorageContainer updatedStorageContainer = (StorageContainer) appService.updateObject(storageContainer,bean);
...
//			storageContainer1 = (StorageContainer) appService.createObject(storageContainer1,bean); 
...
//			storageContainer2 = (StorageContainer) appService.createObject(storageContainer2,bean); 
//			System.out.println("ChildStorageContainer created successfully");
//			
//			assertTrue("Object added successfully", true);
//		 }
...
//	    	System.out.println("After Update");
//	    	StorageContainer updatedStorageContainer1 = (StorageContainer) appService.updateObject(storageContainer1,bean);
...
//	    	System.out.println("After Update");
//	    	StorageContainer updatedStorageContainer2 = (StorageContainer) appService.updateObject(storageContainer2,bean);
