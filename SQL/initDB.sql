...
insert into CATISSUE_TABLE_RELATION (PARENT_TABLE_ID,CHILD_TABLE_ID) select PARENT_TABLE_ID,CHILD_TABLE_ID from catissuecore.CATISSUE_TABLE_RELATION;
...
insert into CATISSUE_QUERY_INTERFACE_COLUMN_DATA ( TABLE_ID, COLUMN_NAME , DISPLAY_NAME , ATTRIBUTE_TYPE ) values ( 37, 'QUANTITY', 'Specimen Quantity', 'double');
insert into CATISSUE_QUERY_INTERFACE_COLUMN_DATA ( TABLE_ID, COLUMN_NAME , DISPLAY_NAME , ATTRIBUTE_TYPE ) values ( 37, 'SPECIMEN_ID', 'Specimen Identifier', 'bigint');
...
insert into CATISSUE_QUERY_INTERFACE_COLUMN_DATA ( TABLE_ID, COLUMN_NAME , DISPLAY_NAME , ATTRIBUTE_TYPE ) values ( 38, 'TO_SITE_ID', 'To Site Identifier', 'bigint');
insert into CATISSUE_QUERY_INTERFACE_COLUMN_DATA ( TABLE_ID, COLUMN_NAME , DISPLAY_NAME , ATTRIBUTE_TYPE ) values ( 38, 'FROM_SITE_ID', 'From Site Identifier', 'bigint');
insert into CATISSUE_QUERY_INTERFACE_COLUMN_DATA ( TABLE_ID, COLUMN_NAME , DISPLAY_NAME , ATTRIBUTE_TYPE ) values ( 38, 'DISTRIBUTION_PROTOCOL_ID', 'Distribution Protocol Identifier', 'bigint');
...
insert into CATISSUE_TABLE_RELATION (PARENT_TABLE_ID,CHILD_TABLE_ID) values (38 , 38);
insert into CATISSUE_TABLE_RELATION (PARENT_TABLE_ID,CHILD_TABLE_ID) values (38 , 37);
