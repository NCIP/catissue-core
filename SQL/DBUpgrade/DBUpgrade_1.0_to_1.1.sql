...
insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_IDI) values ( 74, 'CATISSUE_QUANTITY', 'Quantity', 'Quantity',0);
...
/*Removed this relationtion, refer Bug-638 -Prafull*/
...
INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME) VALUES (30, 320, 'Name');
...
/* Aarti: Bug#1496- To allow query on initial quantity as well as available quantity */
INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME) VALUES (34, 103, 'Initial Quantity');
INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME) VALUES (34, 104, 'Available Quantity');
INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME) VALUES (34, 105, 'Concentration');
/* Aarti: Added for Bug#2352- User can not search for specific specimen. */
INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME) VALUES (34, 322, 'Lineage');
INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME) VALUES (34, 323, 'Label');
...
INSERT INTO CATISSUE_TABLE_RELATION (RELATIONSHIP_ID, PARENT_TABLE_ID, CHILD_TABLE_ID) values (121,75,72);
INSERT INTO CATISSUE_TABLE_RELATION (RELATIONSHIP_ID, PARENT_TABLE_ID, CHILD_TABLE_ID) values (122,75,75);
INSERT INTO CATISSUE_RELATED_TABLES_MAP(FIRST_TABLE_ID,SECOND_TABLE_ID,FIRST_TABLE_JOIN_COLUMN,SECOND_TABLE_JOIN_COLUMN) VALUES(75,72,'IDENTIFIER','DISTRIBUTION_ID');
...
INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME) VALUES (121, 321 , 'Distribution Id');
commit;
#-------- finish
...
#--- Start: Changes for Default view 
update CATISSUE_SEARCH_DISPLAY_DATA
set default_view_attribute = 1
where relationship_id in ( select relationship_id from CATISSUE_TABLE_RELATION
where parent_table_id = child_table_id)
#-- End