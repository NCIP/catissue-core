...
alter table DYEXTN_CATEGORY_ATTRIBUTE add index FKEF3B77584DC2CD16 (ABSTRACT_ATTRIBUTE_ID), add constraint FKEF3B77584DC2CD16 foreign key (ABSTRACT_ATTRIBUTE_ID) references DYEXTN_ATTRIBUTE (IDENTIFIER);
