...
drop sequence CATISSUE_RACE_SEQ;
...
INSERT INTO CSM_PRIVILEGE VALUES(13,'USER_PROVISIONING','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR USER CREATION AND 

ASSIGNING PRIVILEGES TO THAT USER',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(14,'REPOSITORY_ADMINISTRATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

SITES',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(15,'STORAGE_ADMINISTRATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

STORAGE TYPES AND CONTAINERS',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(16,'PROTOCOL_ADMINISTRATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

COLLECTION AS WELL AS DISTRIBUTION PROTOCOLS',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(17,'DEFINE_ANNOTATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

ANNOTATIONS',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(18,'REGISTRATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR REGISTERING PARTICIPANT 

AND CONSENTS',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(20,'SPECIMEN_ACCESSION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

SPECIMEN,SPECIMEN COLLECTION GROUP AND CONSENTS',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(21,'DISTRIBUTION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR 

DISTRIBUTION',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(22,'QUERY','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR 

QUERY',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(23,'PHI','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR VIEWING PHI 

DATA',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(24,'PARTICIPANT_SCG_ANNOTATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

ANNOTATION TO PARTICIPANT OR SCG',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(25,'SPECIMEN_ANNOTATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR FOR ADD EDIT 

SPECIMEN ANNOTATION',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(26,'SPECIMEN_PROCESSIONG','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT ALIQUOT, 

DERIVATIVE, EVENTS',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(27,'SPECIMEN_STORAGE','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT STORAGE AND 

TRANSFER EVENTS',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(28,'GENERAL_SITE_ADMINISTRATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

SITES',TO_DATE('2008-06-19','YYYY-MM-DD'));
INSERT INTO CSM_PRIVILEGE VALUES(29,'GENERAL_ADMINISTRATION','THIS PRIVILEGE GRANTS PERMISSION TO A USER FOR ADD EDIT 

DEPARTMENT,INSTITUTION,CANCER RESEARCH GROUP',TO_DATE('2008-06-19','YYYY-MM-DD'));
COMMIT;

INSERT INTO CSM_ROLE VALUES(13,'SUPERADMINISTRATOR','SUPER ADMINISTRATOR ROLE',1,0,TO_DATE('2008-06-19','YYYY-MM-DD'));

INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,13,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,17,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,14,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,15,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,16,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,18,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,20,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,21,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,22,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,23,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,24,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,25,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,26,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,27,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,28,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,13,29,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;

INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,13,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,14,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,15,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,16,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,18,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,20,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,21,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,22,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,23,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,24,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,25,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,26,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,27,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,1,28,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;

INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,18,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,20,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,21,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,22,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,23,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,24,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,25,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,26,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,2,27,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;

INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,3,21,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,3,22,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,3,25,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,3,26,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;
INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,3,27,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 

CSM_ROLE_PRIVILEGE;

INSERT INTO CSM_ROLE_PRIVILEGE SELECT MAX(ROLE_PRIVILEGE_ID)+1,7,22,TO_DATE('2008-06-19','YYYY-MM-DD') FROM 
...
ALTER TABLE CATISSUE_SITE_CP ADD CONSTRAINT FK4 FOREIGN KEY (COLLECTION_PROTOCOL_ID) REFERENCES CATISSUE_COLLECTION_PROTOCOL 

(IDENTIFIER);

ALTER TABLE CATISSUE_USER_CP ADD CONSTRAINT FK5 FOREIGN KEY (USER_ID) REFERENCES CATISSUE_USER (IDENTIFIER);
ALTER TABLE CATISSUE_USER_CP ADD CONSTRAINT FK6 FOREIGN KEY (COLLECTION_PROTOCOL_ID) REFERENCES CATISSUE_COLLECTION_PROTOCOL 
