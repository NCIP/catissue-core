...
INSERT INTO CSM_USER_GROUP_ROLE_PG SELECT CSM_USER_GROU_USER_GROUP_R_SEQ.NEXTVAL ,NULL,4,MAX(c.ROLE_ID),MAX(b.protection_group_id),TO_DATE('0001-01-01','yyyy-mm-dd') FROM CSM_USER_GROUP_ROLE_PG a,CSM_PROTECTION_GROUP b ,CSM_ROLE c;
