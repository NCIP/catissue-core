...
ASSIGNING PRIVILEGES TO THAT USER','2008-06-19');
...
DEPARTMENT,INSTITUTION,CANCER RESEARCH GROUP','2008-06-19');
COMMIT;
...
ALTER TABLE CATISSUE_SITE_USERS ADD INDEX FK1 (USER_ID), ADD CONSTRAINT FK1 FOREIGN KEY (USER_ID) REFERENCES CATISSUE_USER 

(IDENTIFIER);
ALTER TABLE CATISSUE_SITE_USERS ADD INDEX FK2 (SITE_ID), ADD CONSTRAINT FK2 FOREIGN KEY (SITE_ID) REFERENCES CATISSUE_SITE 

(IDENTIFIER);

ALTER TABLE CATISSUE_SITE_CP ADD INDEX FK3 (SITE_ID), ADD CONSTRAINT FK3 FOREIGN KEY (SITE_ID) REFERENCES CATISSUE_SITE 

(IDENTIFIER);
ALTER TABLE CATISSUE_SITE_CP ADD INDEX FK4 (COLLECTION_PROTOCOL_ID), ADD CONSTRAINT FK4 FOREIGN KEY (COLLECTION_PROTOCOL_ID) 

REFERENCES CATISSUE_COLLECTION_PROTOCOL (IDENTIFIER);

ALTER TABLE CATISSUE_USER_CP ADD INDEX FK5 (USER_ID), ADD CONSTRAINT FK5 FOREIGN KEY (USER_ID) REFERENCES CATISSUE_USER 

(IDENTIFIER);
ALTER TABLE CATISSUE_USER_CP ADD INDEX FK6 (COLLECTION_PROTOCOL_ID), ADD CONSTRAINT FK6 FOREIGN KEY (COLLECTION_PROTOCOL_ID) 
