...
insert into catissue_container_type (IDENTIFIER,CAPACITY_ID,NAME,ONE_DIMENSION_LABEL,TWO_DIMENSION_LABEL,COMMENTS,ACTIVITY_STATUS) values ( '1',NULL,'Any',NULL,NULL,NULL,'Disabled');
