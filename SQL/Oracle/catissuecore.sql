...
alter table CATISSUE_STOR_CONT_STOR_TYPE_REL drop constraint FK703B902159A3CE5C;
alter table CATISSUE_STOR_CONT_STOR_TYPE_REL drop constraint FK703B9021B3DFB11D;
...
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT drop constraint FKBEA9D458C4A3C438;
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT drop constraint FKBEA9D45860773DB2;
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT drop constraint FKBEA9D45892AB74B4;
...
alter table CATISSUE_STORAGE_CONT_COLL_PROT_REL drop constraint FK3AE9FCA7B3DFB11D;
alter table CATISSUE_STORAGE_CONT_COLL_PROT_REL drop constraint FK3AE9FCA748304401;
...
drop table  CATISSUE_SPECIMEN_ARRAY_CONTENT;
...
drop   sequence CATISSUE_SPECIMEN_ARRAY_CONTENT;
...
alter table CATISSUE_COLL_EVENT_PARAM add  add constraint FKF9888F91BC7298A9 foreign key (IDENTIFIER) references CATISSUE_SPECIMEN_EVENT_PARAM  ;
...
#--alter table CATISSUE_STORAGE_TYPE  add constraint FKE9A0629A81236791 foreign key (HOLDS_STORAGE_TYPE_ID) references CATISSUE_STORAGE_TYPE  ;
...
alter table CATISSUE_STOR_CONT_STOR_TYPE_REL  add constraint FK703B902159A3CE5C foreign key (STORAGE_TYPE_ID) references CATISSUE_STORAGE_TYPE  ;
alter table CATISSUE_STOR_CONT_STOR_TYPE_REL  add constraint FK703B9021B3DFB11D foreign key (STORAGE_CONTAINER_ID) references CATISSUE_STORAGE_CONTAINER  ;
...
alter table CATISSUE_SPECIMEN_PROTOCOL add  add constraint FKB8481373870EB740 foreign key (PRINCIPAL_INVESTIGATOR_ID) references CATISSUE_USER  ;
...
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT  add constraint FKBEA9D458C4A3C438 foreign key (SPECIMEN_ARRAY_ID) references CATISSUE_SPECIMEN_ARRAY  ;
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT  add constraint FKBEA9D45860773DB2 foreign key (SPECIMEN_ID) references CATISSUE_SPECIMEN  ;
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT  add constraint FKBEA9D45892AB74B4 foreign key (INITIAL_QUANTITY_ID) references CATISSUE_QUANTITY  ;
...
alter table CATISSUE_STORAGE_CONT_COLL_PROT_REL  add constraint FK3AE9FCA7B3DFB11D foreign key (STORAGE_CONTAINER_ID) references CATISSUE_STORAGE_CONTAINER  ;
alter table CATISSUE_STORAGE_CONT_COLL_PROT_REL  add constraint FK3AE9FCA748304401 foreign key (COLLECTION_PROTOCOL_ID) references CATISSUE_COLLECTION_PROTOCOL  ;
...
create sequence CATISSUE_SPECIMEN_ARRAY_CONTENT;
