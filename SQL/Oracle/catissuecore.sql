...
alter table CATISSUE_RETURN_EVENT_PARAMETERS drop constraint FKD8890A48BC7298A91;
...
drop table  CATISSUE_RETURN_EVENT_PARAMETERS;
...
create table CATISSUE_SPECIMEN_COLL_GROUP (
   ...
   IDENTIFIED_REPORT_ID number(19,0),
   primary key (IDENTIFIER)
);
...
alter table CATISSUE_SPECIMEN_COLL_GROUP add constraint FKDEBAF16787E5ADC7 foreign key (PARTICIPANT_ID) references CATISSUE_PARTICIPANT (IDENTIFIER);
alter table CATISSUE_RETURN_EVENT_PARAMETERS  add constraint FKD8890A48BC7298A91 foreign key (IDENTIFIER) references CATISSUE_SPECIMEN_EVENT_PARAM  ;
