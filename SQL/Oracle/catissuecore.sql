...
alter table CATISSUE_DISTRIBUTION_SPEC_REQ  add constraint FK39AFE96861A1C94F foreign key (DISTRIBUTION_PROTOCOL_ID) references CATISSUE_DISTRIBUTION_PROTOCOL  ;
