insert into catissue_user (IDENTIFIER, ACTIVITY_STATUS, CSM_USER_ID, EMAIL_ADDRESS,LOGIN_NAME,FIRST_NAME,LAST_NAME,IS_ADMIN) values (CATISSUE_USER_SEQ.nextval,'Active',1,'admin@admin.com','admin@admin.com','Admin','Admin',1);
