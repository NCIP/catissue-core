...
/*Metadata for SCG due to model changes*/

UPDATE CATISSUE_INTERFACE_COLUMN_DATA set TABLE_ID = 92 where IDENTIFIER = 320;

UPDATE CATISSUE_SEARCH_DISPLAY_DATA set RELATIONSHIP_ID = 137 where RELATIONSHIP_ID = 30 and COL_ID = 320;