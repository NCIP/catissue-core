...
insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_ID, FOR_SQI) values ( 44, 'CATISSUE_IN_OUT_EVENT_PARAM', 'Checkin Checkout Event Parameter', 'CheckinCheckoutEventParam',2,2);
...
insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_ID, FOR_SQI) values ( 46, 'CATISSUE_COLL_EVENT_PARAM', 'Collection Event Parameters', 'CollectionEventParameters',2,2);
...
insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_ID, FOR_SQI) values ( 47, 'CATISSUE_DISPOSAL_EVENT_PARAM', 'Disposal Event Parameters', 'DisposalEventParameters',2,2);
...
insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_ID, FOR_SQI) values ( 48, 'CATISSUE_EMBEDDED_EVENT_PARAM', 'Embedded Event Parameters', 'EmbeddedEventParameters',2,2);
...
insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_ID, FOR_SQI) values ( 54, 'CATISSUE_PROCEDURE_EVENT_PARAM', 'Procedure Event Parameters', 'ProcedureEventParameters',2,2);
...
insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_ID, FOR_SQI) values ( 57, 'CATISSUE_RECEIVED_EVENT_PARAM', 'Received Event Parameters', 'ReceivedEventParameters',2,2);
...
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 208, 34, 'PATHOLOGICAL_STATUS', 'varchar');
...
/*Kapil: added*/
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 37, 12, 'QUANTITY', 'double');
...
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 240, 21, 'CONTAINER_NUMBER', 'integer');
...
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 242, 21, 'IS_CONTAINER_FULL', 'tinyint');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 243, 21, 'BARCODE', 'varchar');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 244, 21, 'ACTIVITY_STATUS', 'varchar');
...
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 247, 21, 'PARENT_CONTAINER_ID', 'bigint');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 248, 21, 'STORAGE_CONTAINER_CAPACITY_ID', 'bigint');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 249, 21, 'POSITION_DIMENSION_ONE', 'integer');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 250, 21, 'POSITION_DIMENSION_TWO', 'integer');

insert into CATISSUE_QUERY_TABLE_DATA  ( TABLE_ID, TABLE_NAME, DISPLAY_NAME, ALIAS_NAME, PRIVILEGE_ID) values ( 2, 'CATISSUE_STORAGE_CONT_CAPACITY', 'Storage Container Capacity', 'StorageContainerCapacity',2);
...
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 259, 1, 'TYPE', 'varchar');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 260, 1, 'DEFAULT_TEMP_IN_CENTIGRADE', 'double');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 261, 1, 'ONE_DIMENSION_LABEL', 'varchar');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 262, 1, 'TWO_DIMENSION_LABEL', 'varchar');
insert into CATISSUE_INTERFACE_COLUMN_DATA ( IDENTIFIER, TABLE_ID, COLUMN_NAME , ATTRIBUTE_TYPE ) values ( 263, 1, 'STORAGE_CONTAINER_CAPACITY_ID', 'bigint');
