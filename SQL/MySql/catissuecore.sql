alter table CATISSUE_INTERFACE_COLUMN_DATA drop foreign key FK9C900851F947634C;
...
alter table CATISSUE_STORAGE_CONT_DETAILS drop foreign key FK3531F575B3DFB11D;
...
drop table if exists CATISSUE_STORAGE_CONT_CAPACITY;
...
alter table CATISSUE_INTERFACE_COLUMN_DATA add index FK9C900851F947634C (TABLE_ID), add constraint FK9C900851F947634C foreign key (TABLE_ID) references CATISSUE_QUERY_TABLE_DATA (TABLE_ID);
...
alter table CATISSUE_STORAGE_TYPE add index FKE9A0629A5F7CB0FE (STORAGE_CONTAINER_CAPACITY_ID), add constraint FKE9A0629A5F7CB0FE foreign key (STORAGE_CONTAINER_CAPACITY_ID) references CATISSUE_STORAGE_CONT_CAPACITY (IDENTIFIER);
...
alter table CATISSUE_STORAGE_CONT_DETAILS add index FK3531F575B3DFB11D (STORAGE_CONTAINER_ID), add constraint FK3531F575B3DFB11D foreign key (STORAGE_CONTAINER_ID) references CATISSUE_STORAGE_CONTAINER (IDENTIFIER);
...
alter table CATISSUE_STORAGE_CONTAINER add index FK28429D015F7CB0FE (STORAGE_CONTAINER_CAPACITY_ID), add constraint FK28429D015F7CB0FE foreign key (STORAGE_CONTAINER_CAPACITY_ID) references CATISSUE_STORAGE_CONT_CAPACITY (IDENTIFIER);
...
alter table CATISSUE_DISTRIBUTION add index FK54276680BC7298A9 (IDENTIFIER), add constraint FK54276680BC7298A9 foreign key (IDENTIFIER) references CATISSUE_SPECIMEN_EVENT_PARAM (IDENTIFIER);
...
ALTER TABLE CATISSUE_COLL_SPECIMEN_REQ ADD COLUMN  IDENTIFIER bigint(20);
ALTER TABLE CATISSUE_DISTRIBUTION_SPE_REQ ADD COLUMN  IDENTIFIER bigint(20);
