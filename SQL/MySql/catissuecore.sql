...
alter table CATISSUE_STOR_CONT_STOR_TYPE_REL drop foreign key FK703B902159A3CE5C;
alter table CATISSUE_STOR_CONT_STOR_TYPE_REL drop foreign key FK703B9021B3DFB11D;
...
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT drop foreign key FKBEA9D458C4A3C438;
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT drop foreign key FKBEA9D45860773DB2;
alter table CATISSUE_SPECIMEN_ARRAY_CONTENT drop foreign key FKBEA9D45892AB74B4;
...
alter table CATISSUE_STORAGE_CONT_COLL_PROT_REL drop foreign key FK3AE9FCA7B3DFB11D;
alter table CATISSUE_STORAGE_CONT_COLL_PROT_REL drop foreign key FK3AE9FCA748304401;
...
drop table if exists CATISSUE_SPECIMEN_ARRAY_CONTENT;
